...
import { initMessageBoard, initContactForm, initBlog, initSaveBackgroundImage, trackVisit, loadStats } from './social.js';
...
import { initGeneralStore } from './general-store.js';
import './runner.js';
...
export async function initApp() {
  ...
  if (!prefersReducedMotion()) {
    initWeather(document.getElementById('rain-canvas'));
  }
...
// Rain is fixed; no weather controls are registered.
