    ...
    widget.innerHTML = 
        '<div class="music-panel" id="musicPanel">' +
            '<div class="music-panel-inner">' +
                ...
                '<iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width="330" height="370" src="https://music.163.com/outchain/player?type=0&id=3779629&auto=0&height=370" style="width:100%;height:370px;display:block;border-radius:12px;"></iframe>' +
            '</div>' +
        '</div>' +
