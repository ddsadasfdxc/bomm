...
#define LOW_PRECISION`),t}function Ig(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===du?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===hd?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===Pn&&(t="SHADOWMAP_TYPE_VSM"),t}function Ug(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case hr:case dr:t="ENVMAP_TYPE_CUBE";break;case na:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Ng(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case dr:t="ENVMAP_MODE_REFRACTION";break}return t}function Og(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case fu:t="ENVMAP_BLENDING_MULTIPLY";break;case Fd:t="ENVMAP_BLENDING_MIX";break;case Bd:t="ENVMAP_BLENDING_ADD";break}return t}function Fg(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Bg(r,t,e,n){const i=r.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Ig(e),c=Ug(e),u=Ng(e),d=Og(e),h=Fg(e),m=Ag(e),g=bg(s),_=i.createProgram();let f,p,y=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `});return new xv(e,a)}animate(){this.particles.material.uniforms.uTime.value=this.clock.getElapsedTime(),this.renderer.render(this.scene,this.camera)}onResize(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight)}destroy(){window.removeEventListener("resize",this.resizeHandler),this.renderer.dispose(),this.container.removeChild(this.renderer.domElement)}}class Sv{constructor(t,e={}){this.scene=t,this.count=e.count||6,this.planes=[],this.createClouds()}createClouds(){const t=new Jr(120,40,32,16),e=new yn({transparent:!0,side:_n,depthWrite:!1,uniforms:{uColor:{value:new kt(5995126)},uOpacity:{value:.08}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var Xc,Zn,cr,bl,Ci,qc,wl,y0=function(){return typeof window<"u"},kn={},yi=180/Math.PI,ur=Math.PI/180,er=Math.atan2,Yc=1e8,Cl=/([A-Z])/g,E0=/(left|right|width|margin|padding|x)/i,T0=/[\s,\(]\S/,Mn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},qo=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},A0=function(t,e){return e.set(e.t,e.p,t===1?e.e:Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},b0=function(t,e){return e.set(e.t,e.p,t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},w0=function(t,e){return e.set(e.t,e.p,t===1?e.e:t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},C0=function(t,e){var n=e.s+e.c*t;e.set(e.t,e.p,~~(n+(n<0?-.5:.5))+e.u,e)},Dh=function(t,e){return e.set(e.t,e.p,t?e.e:e.b,e)},Ih=function(t,e){return e.set(e.t,e.p,t!==1?e.b:e.e,e)},R0=function(t,e,n){return t.style[e]=n},P0=function(t,e,n){return t.style.setProperty(e,n)},L0=function(t,e,n){return t._gsap[e]=n},D0=function(t,e,n){return t._gsap.scaleX=t._gsap.scaleY=n},I0=function(t,e,n,i,s){var a=t._gsap;a.scaleX=a.scaleY=n,a.renderTransform(s,a)},U0=function(t,e,n,i,s){var a=t._gsap;a[e]=n,a.renderTransform(s,a)},re="transform",Be=re+"Origin",N0=function r(t,e){var n=this,i=this.target,s=i.style,a=i._gsap;if(t in kn&&s){if(this.tfm=this.tfm||{},t!=="transform")t=Mn[t]||t,~t.indexOf(",")?t.split(",").forEach(function(o){return n.tfm[o]=Dn(i,o)}):this.tfm[t]=a.x?a[t]:Dn(i,t),t===Be&&(this.tfm.zOrigin=a.zOrigin);else return Mn.transform.split(",").forEach(function(o){return r.call(n,o,e)});if(this.props.indexOf(re)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(Be,e,"")),t=re}(s||e)&&this.props.push(t,e,s[t])},Uh=function(t){t.translate&&(t.removeProperty("translate"),t.removeProperty("scale"),t.removeProperty("rotate"))},O0=function(){var t=this.props,e=this.target,n=e.style,i=e._gsap,s,a;for(s=0;s<t.length;s+=3)t[s+1]?t[s+1]===2?e[t[s]](t[s+2]):e[t[s]]=t[s+2]:t[s+2]?n[t[s]]=t[s+2]:n.removeProperty(t[s].substr(0,2)==="--"?t[s]:t[s].replace(Cl,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),e.setAttribute("data-svg-origin",this.svgo||"")),s=wl(),(!s||!s.isStart)&&!n[re]&&(Uh(n),i.zOrigin&&n[Be]&&(n[Be]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},Nh=function(t,e){var n={target:t,props:[],revert:O0,save:N0};return t._gsap||ze.core.getCache(t),e&&t.style&&t.nodeType&&e.split(",").forEach(function(i){return n.save(i)}),n},Oh,Yo=function(t,e){var n=Zn.createElementNS?Zn.createElementNS((e||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),t):Zn.createElement(t);return n&&n.style?n:Zn.createElement(t)},Ye=function r(t,e,n){var i=getComputedStyle(t);return i[e]||i.getPropertyValue(e.replace(Cl,"-$1").toLowerCase())||i.getPropertyValue(e)||!n&&r(t,Mr(e)||e,1)||""},$c="O,Moz,ms,Ms,Webkit".split(","),Mr=function(t,e,n){var i=e||Ci,s=i.style,a=5;if(t in s&&!n)return t;for(t=t.charAt(0).toUpperCase()+t.substr(1);a--&&!($c[a]+t in s););return a<0?null:(a===3?"ms":a>=0?$c[a]:"")+t},$o=function(){y0()&&window.document&&(Xc=window,Zn=Xc.document,cr=Zn.documentElement,Ci=Yo("div")||{style:{}},Yo("div"),re=Mr(re),Be=re+"Origin",Ci.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",Oh=!!Mr("perspective"),wl=ze.core.reverting,bl=1)},Kc=function(t){var e=t.ownerSVGElement,n=Yo("svg",e&&e.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),i=t.cloneNode(!0),s;i.style.display="block",n.appendChild(i),cr.appendChild(n);try{s=i.getBBox()}catch{}return n.removeChild(i),cr.removeChild(n),s},jc=function(t,e){for(var n=e.length;n--;)if(t.hasAttribute(e[n]))return t.getAttribute(e[n])},Fh=function(t){var e,n;try{e=t.getBBox()}catch{e=Kc(t),n=1}return e&&(e.width||e.height)||n||(e=Kc(t)),e&&!e.width&&!e.x&&!e.y?{x:+jc(t,["x","cx","x1"])||0,y:+jc(t,["y","cy","y1"])||0,width:0,height:0}:e},Bh=function(t){return!!(t.getCTM&&(!t.parentNode||t.ownerSVGElement)&&Fh(t))},ai=function(t,e){if(e){var n=t.style,i;e in kn&&e!==Be&&(e=re),n.removeProperty?(i=e.substr(0,2),(i==="ms"||e.substr(0,6)==="webkit")&&(e="-"+e),n.removeProperty(i==="--"?e:e.replace(Cl,"-$1").toLowerCase())):n.removeAttribute(e)}},Jn=function(t,e,n,i,s,a){var o=new Fe(t._pt,e,n,0,1,a?Ih:Dh);return t._pt=o,o.b=i,o.e=s,t._props.push(n),o},Zc={deg:1,rad:1,turn:1},F0={grid:1,flex:1},oi=function r(t,e,n,i){var s=parseFloat(n)||0,a=(n+"").trim().substr((s+"").length)||"px",o=Ci.style,l=E0.test(e),c=t.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),d=100,h=i==="px",m=i==="%",g,_,f,p;if(i===a||!s||Zc[i]||Zc[a])return s;if(a!=="px"&&!h&&(s=r(t,e,n,"px")),p=t.getCTM&&Bh(t),(m||a==="%")&&(kn[e]||~e.indexOf("adius")))return g=p?t.getBBox()[l?"width":"height"]:t[u],ce(m?s/g*d:s/100*g);if(o[l?"width":"height"]=d+(h?a:i),_=i!=="rem"&&~e.indexOf("adius")||i==="em"&&t.appendChild&&!c?t:t.parentNode,p&&(_=(t.ownerSVGElement||{}).parentNode),(!_||_===Zn||!_.appendChild)&&(_=Zn.body),f=_._gsap,f&&m&&f.width&&l&&f.time===Xe.time&&!f.uncache)return ce(s/f.width*d);if(m&&(e==="height"||e==="width")){var y=t.style[e];t.style[e]=d+i,g=t[u],y?t.style[e]=y:ai(t,e)}else(m||a==="%")&&!F0[Ye(_,"display")]&&(o.position=Ye(t,"position")),_===t&&(o.position="static"),_.appendChild(Ci),g=Ci[u],_.removeChild(Ci),o.position="absolute";return l&&m&&(f=Pi(_),f.time=Xe.time,f.width=_[u]),ce(h?g*s/d:g&&s?d/g*s:0)},Dn=function(t,e,n,i){var s;return bl||$o(),e in Mn&&e!=="transform"&&(e=Mn[e],~e.indexOf(",")&&(e=e.split(",")[0])),kn[e]&&e!=="transform"?(s=Wr(t,i),s=e!=="transformOrigin"?s[e]:s.svg?s.origin:Zs(Ye(t,Be))+" "+s.zOrigin+"px"):(s=t.style[e],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=js[e]&&js[e](t,e,n)||Ye(t,e)||nh(t,e)||(e==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?oi(t,e,s,n)+n:s},B0=function(t,e,n,i){if(!n||n==="none"){var s=Mr(e,t,1),a=s&&Ye(t,s,1);a&&a!==n?(e=s,n=a):e==="borderColor"&&(n=Ye(t,"borderTopColor"))}var o=new Fe(this._pt,t.style,e,0,1,Rh),l=0,c=0,u,d,h,m,g,_,f,p,y,v,T,w;if(o.b=n,o.e=i,n+="",i+="",i.substring(0,6)==="var(--"&&(i=Ye(t,i.substring(4,i.indexOf(")")))),i==="auto"&&(_=t.style[e],t.style[e]=i,i=Ye(t,e)||i,_?t.style[e]=_:ai(t,e)),u=[n,i],Sh(u),n=u[0],i=u[1],h=n.match(ir)||[],w=i.match(ir)||[],w.length){for(;d=ir.exec(i);)f=d[0],y=i.substring(l,d.index),g?g=(g+1)%5:(y.substr(-5)==="rgba("||y.substr(-5)==="hsla(")&&(g=1),f!==(_=h[c++]||"")&&(m=parseFloat(_)||0,T=_.substr((m+"").length),f.charAt(1)==="="&&(f=lr(m,f)+T),p=parseFloat(f),v=f.substr((p+"").length),l=ir.lastIndex-v.length,v||(v=v||Ke.units[e]||T,l===i.length&&(i+=v,o.e+=v)),T!==v&&(m=oi(t,e,_,v)||0),o._pt={_next:o._pt,p:y||c===1?y:",",s:m,c:p-m,m:g&&g<4||e==="zIndex"?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=e==="display"&&i==="none"?Ih:Dh;return Zu.test(i)&&(o.e=0),this._pt=o,o},Jc={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},z0=function(t){var e=t.split(" "),n=e[0],i=e[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(t=n,n=i,i=t),e[0]=Jc[n]||n,e[1]=Jc[i]||i,e.join(" ")},k0=function(t,e){if(e.tween&&e.tween._time===e.tween._dur){var n=e.t,i=n.style,s=e.u,a=n._gsap,o,l,c;if(s==="all"||s===!0)i.cssText="",l=1;else for(s=s.split(","),c=s.length;--c>-1;)o=s[c],kn[o]&&(l=1,o=o==="transformOrigin"?Be:re),ai(n,o);l&&(ai(n,re),a&&(a.svg&&n.removeAttribute("transform"),i.scale=i.rotate=i.translate="none",Wr(n,1),a.uncache=1,Uh(i)))}},js={clearProps:function(t,e,n,i,s){if(s.data!=="isFromStart"){var a=t._pt=new Fe(t._pt,e,n,0,0,k0);return a.u=i,a.pr=-10,a.tween=s,t._props.push(n),1}}},Gr=[1,0,0,1,0,0],zh={},kh=function(t){return t==="matrix(1, 0, 0, 1, 0, 0)"||t==="none"||!t},Qc=function(t){var e=Ye(t,re);return kh(e)?Gr:e.substr(7).match(ju).map(ce)},Rl=function(t,e){var n=t._gsap||Pi(t),i=t.style,s=Qc(t),a,o,l,c;return n.svg&&t.getAttribute("transform")?(l=t.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?Gr:s):(s===Gr&&!t.offsetParent&&t!==cr&&!n.svg&&(l=i.display,i.display="block",a=t.parentNode,(!a||!t.offsetParent&&!t.getBoundingClientRect().width)&&(c=1,o=t.nextElementSibling,cr.appendChild(t)),s=Qc(t),l?i.display=l:ai(t,"display"),c&&(o?a.insertBefore(t,o):a?a.appendChild(t):cr.removeChild(t))),e&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},Ko=function(t,e,n,i,s,a){var o=t._gsap,l=s||Rl(t,!0),c=o.xOrigin||0,u=o.yOrigin||0,d=o.xOffset||0,h=o.yOffset||0,m=l[0],g=l[1],_=l[2],f=l[3],p=l[4],y=l[5],v=e.split(" "),T=parseFloat(v[0])||0,w=parseFloat(v[1])||0,b,A,C,M;n?l!==Gr&&(A=m*f-g*_)&&(C=T*(f/A)+w*(-_/A)+(_*y-f*p)/A,M=T*(-g/A)+w*(m/A)-(m*y-g*p)/A,T=C,w=M):(b=Fh(t),T=b.x+(~v[0].indexOf("%")?T/100*b.width:T),w=b.y+(~(v[1]||v[0]).indexOf("%")?w/100*b.height:w)),i||i!==!1&&o.smooth?(p=T-c,y=w-u,o.xOffset=d+(p*m+y*_)-p,o.yOffset=h+(p*g+y*f)-y):o.xOffset=o.yOffset=0,o.xOrigin=T,o.yOrigin=w,o.smooth=!!i,o.origin=e,o.originIsAbsolute=!!n,t.style[Be]="0px 0px",a&&(Jn(a,o,"xOrigin",c,T),Jn(a,o,"yOrigin",u,w),Jn(a,o,"xOffset",d,o.xOffset),Jn(a,o,"yOffset",h,o.yOffset)),t.setAttribute("data-svg-origin",T+" "+w)},Wr=function(t,e){var n=t._gsap||new Eh(t);if("x"in n&&!e&&!n.uncache)return n;var i=t.style,s=n.scaleX<0,a="px",o="deg",l=getComputedStyle(t),c=Ye(t,Be)||"0",u,d,h,m,g,_,f,p,y,v,T,w,b,A,C,M,x,P,k,N,X,V,G,q,H,rt,ot,lt,Ct,pt,W,j;return u=d=h=_=f=p=y=v=T=0,m=g=1,n.svg=!!(t.getCTM&&Bh(t)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[re]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[re]!=="none"?l[re]:"")),i.scale=i.rotate=i.translate="none"),A=Rl(t,n.svg),n.svg&&(n.uncache?(H=t.getBBox(),c=n.xOrigin-H.x+"px "+(n.yOrigin-H.y)+"px",q=""):q=!e&&t.getAttribute("data-svg-origin"),Ko(t,q||c,!!q||n.originIsAbsolute,n.smooth!==!1,A)),w=n.xOrigin||0,b=n.yOrigin||0,A!==Gr&&(P=A[0],k=A[1],N=A[2],X=A[3],u=V=A[4],d=G=A[5],A.length===6?(m=Math.sqrt(P*P+k*k),g=Math.sqrt(X*X+N*N),_=P||k?er(k,P)*yi:0,y=N||X?er(N,X)*yi+_:0,y&&(g*=Math.abs(Math.cos(y*ur))),n.svg&&(u-=w-(w*P+b*N),d-=b-(w*k+b*X))):(j=A[6],pt=A[7],ot=A[8],lt=A[9],Ct=A[10],W=A[11],u=A[12],d=A[13],h=A[14],C=er(j,Ct),f=C*yi,C&&(M=Math.cos(-C),x=Math.sin(-C),q=V*M+ot*x,H=G*M+lt*x,rt=j*M+Ct*x,ot=V*-x+ot*M,lt=G*-x+lt*M,Ct=j*-x+Ct*M,W=pt*-x+W*M,V=q,G=H,j=rt),C=er(-N,Ct),p=C*yi,C&&(M=Math.cos(-C),x=Math.sin(-C),q=P*M-ot*x,H=k*M-lt*x,rt=N*M-Ct*x,W=X*x+W*M,P=q,k=H,N=rt),C=er(k,P),_=C*yi,C&&(M=Math.cos(C),x=Math.sin(C),q=P*M+k*x,H=V*M+G*x,k=k*M-P*x,G=G*M-V*x,P=q,V=H),f&&Math.abs(f)+Math.abs(_)>359.9&&(f=_=0,p=180-p),m=ce(Math.sqrt(P*P+k*k+N*N)),g=ce(Math.sqrt(G*G+j*j)),C=er(V,G),y=Math.abs(C)>2e-4?C*yi:0,T=W?1/(W<0?-W:W):0),n.svg&&(q=t.getAttribute("transform"),n.forceCSS=t.setAttribute("transform","")||!kh(Ye(t,re)),q&&t.setAttribute("transform",q))),Math.abs(y)>90&&Math.abs(y)<270&&(s?(m*=-1,y+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,y+=y<=0?180:-180)),e=e||n.uncache,n.x=u-((n.xPercent=u&&(!e&&n.xPercent||(Math.round(t.offsetWidth/2)===Math.round(-u)?-50:0)))?t.offsetWidth*n.xPercent/100:0)+a,n.y=d-((n.yPercent=d&&(!e&&n.yPercent||(Math.round(t.offsetHeight/2)===Math.round(-d)?-50:0)))?t.offsetHeight*n.yPercent/100:0)+a,n.z=h+a,n.scaleX=ce(m),n.scaleY=ce(g),n.rotation=ce(_)+o,n.rotationX=ce(f)+o,n.rotationY=ce(p)+o,n.skewX=y+o,n.skewY=v+o,n.transformPerspective=T+a,(n.zOrigin=parseFloat(c.split(" ")[2])||!e&&n.zOrigin||0)&&(i[Be]=Zs(c)),n.xOffset=n.yOffset=0,n.force3D=Ke.force3D,n.renderTransform=n.svg?V0:Oh?Hh:H0,n.uncache=0,n},Zs=function(t){return(t=t.split(" "))[0]+" "+t[1]},ja=function(t,e,n){var i=Ae(e);return ce(parseFloat(e)+parseFloat(oi(t,"x",n+"px",i)))+i},H0=function(t,e){e.z="0px",e.rotationY=e.rotationX="0deg",e.force3D=0,Hh(t,e)},gi="0deg",Cr="0px",vi=") ",Hh=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,u=n.rotationY,d=n.rotationX,h=n.skewX,m=n.skewY,g=n.scaleX,_=n.scaleY,f=n.transformPerspective,p=n.force3D,y=n.target,v=n.zOrigin,T="",w=p==="auto"&&t&&t!==1||p===!0;if(v&&(d!==gi||u!==gi)){var b=parseFloat(u)*ur,A=Math.sin(b),C=Math.cos(b),M;b=parseFloat(d)*ur,M=Math.cos(b),a=ja(y,a,A*M*-v),o=ja(y,o,-Math.sin(b)*-v),l=ja(y,l,C*M*-v+v)}f!==Cr&&(T+="perspective("+f+vi),(i||s)&&(T+="translate("+i+"%, "+s+"%) "),(w||a!==Cr||o!==Cr||l!==Cr)&&(T+=l!==Cr||w?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+vi),c!==gi&&(T+="rotate("+c+vi),u!==gi&&(T+="rotateY("+u+vi),d!==gi&&(T+="rotateX("+d+vi),(h!==gi||m!==gi)&&(T+="skew("+h+", "+m+vi),(g!==1||_!==1)&&(T+="scale("+g+", "+_+vi),y.style[re]=T||"translate(0, 0)"},V0=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,u=n.skewY,d=n.scaleX,h=n.scaleY,m=n.target,g=n.xOrigin,_=n.yOrigin,f=n.xOffset,p=n.yOffset,y=n.forceCSS,v=parseFloat(a),T=parseFloat(o),w,b,A,C,M;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=ur,c*=ur,w=Math.cos(l)*d,b=Math.sin(l)*d,A=Math.sin(l-c)*-h,C=Math.cos(l-c)*h,c&&(u*=ur,M=Math.tan(c-u),M=Math.sqrt(1+M*M),A*=M,C*=M,u&&(M=Math.tan(u),M=Math.sqrt(1+M*M),w*=M,b*=M)),w=ce(w),b=ce(b),A=ce(A),C=ce(C)):(w=d,C=h,b=A=0),(v&&!~(a+"").indexOf("px")||T&&!~(o+"").indexOf("px"))&&(v=oi(m,"x",a,"px"),T=oi(m,"y",o,"px")),(g||_||f||p)&&(v=ce(v+g-(g*w+_*A)+f),T=ce(T+_-(g*b+_*C)+p)),(i||s)&&(M=m.getBBox(),v=ce(v+i/100*M.width),T=ce(T+s/100*M.height)),M="matrix("+w+","+b+","+A+","+C+","+v+","+T+")",m.setAttribute("transform",M),y&&(m.style[re]=M)},G0=function(t,e,n,i,s){var a=360,o=xe(s),l=parseFloat(s)*(o&&~s.indexOf("rad")?yi:1),c=l-i,u=i+c+"deg",d,h;return o&&(d=s.split("_")[1],d==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-a)),d==="cw"&&c<0?c=(c+a*Yc)%a-~~(c/a)*a:d==="ccw"&&c>0&&(c=(c-a*Yc)%a-~~(c/a)*a)),t._pt=h=new Fe(t._pt,e,n,i,c,A0),h.e=u,h.u="deg",t._props.push(n),h},tu=function(t,e){for(var n in e)t[n]=e[n];return t},W0=function(t,e,n){var i=tu({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,u,d,h,m,g;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[re]=e,o=Wr(n,1),ai(n,re),n.setAttribute("transform",c)):(c=getComputedStyle(n)[re],a[re]=e,o=Wr(n,1),a[re]=c);for(l in kn)c=i[l],u=o[l],c!==u&&s.indexOf(l)<0&&(m=Ae(c),g=Ae(u),d=m!==g?oi(n,l,c,g):parseFloat(c),h=parseFloat(u),t._pt=new Fe(t._pt,o,l,d,h-d,qo),t._pt.u=g||0,t._props.push(l));tu(o,i)};Oe("padding,margin,Width,Radius",function(r,t){var e="Top",n="Right",i="Bottom",s="Left",a=(t<3?[e,n,i,s]:[e+s,e+n,i+n,i+s]).map(function(o){return t<2?r+o:"border"+o+r});js[t>1?"border"+r:r]=function(o,l,c,u,d){var h,m;if(arguments.length<4)return h=a.map(function(g){return Dn(o,g,c)}),m=h.join(" "),m.split(h[0]).length===5?h[0]:m;h=(u+"").split(" "),m={},a.forEach(function(g,_){return m[g]=h[_]=h[_]||h[(_-1)/2|0]}),o.init(l,m,d)}});var Vh={name:"css",register:$o,targetTest:function(t){return t.style&&t.nodeType},init:function(t,e,n,i,s){var a=this._props,o=t.style,l=n.vars.startAt,c,u,d,h,m,g,_,f,p,y,v,T,w,b,A,C,M;bl||$o(),this.styles=this.styles||Nh(t),C=this.styles.props,this.tween=n;for(_ in e)if(_!=="autoRound"&&(u=e[_],!(We[_]&&Th(_,e,n,i,t,s)))){if(m=typeof u,g=js[_],m==="function"&&(u=u.call(n,i,t,s),m=typeof u),m==="string"&&~u.indexOf("random(")&&(u=kr(u)),g)g(this,t,_,u,n)&&(A=1);else if(_.substr(0,2)==="--")c=(getComputedStyle(t).getPropertyValue(_)+"").trim(),u+="",ni.lastIndex=0,ni.test(c)||(f=Ae(c),p=Ae(u),p?f!==p&&(c=oi(t,_,c,p)+p):f&&(u+=f)),this.add(o,"setProperty",c,u,i,s,0,0,_),a.push(_),C.push(_,0,o[_]);else if(m!=="undefined"){if(l&&_ in l?(c=typeof l[_]=="function"?l[_].call(n,i,t,s):l[_],xe(c)&&~c.indexOf("random(")&&(c=kr(c)),Ae(c+"")||c==="auto"||(c+=Ke.units[_]||Ae(Dn(t,_))||""),(c+"").charAt(1)==="="&&(c=Dn(t,_))):c=Dn(t,_),h=parseFloat(c),y=m==="string"&&u.charAt(1)==="="&&u.substr(0,2),y&&(u=u.substr(2)),d=parseFloat(u),_ in Mn&&(_==="autoAlpha"&&(h===1&&Dn(t,"visibility")==="hidden"&&d&&(h=0),C.push("visibility",0,o.visibility),Jn(this,o,"visibility",h?"inherit":"hidden",d?"inherit":"hidden",!d)),_!=="scale"&&_!=="transform"&&(_=Mn[_],~_.indexOf(",")&&(_=_.split(",")[0]))),v=_ in kn,v){if(this.styles.save(_),M=u,m==="string"&&u.substring(0,6)==="var(--"){if(u=Ye(t,u.substring(4,u.indexOf(")"))),u.substring(0,5)==="calc("){var x=t.style.perspective;t.style.perspective=u,u=Ye(t,"perspective"),x?t.style.perspective=x:ai(t,"perspective")}d=parseFloat(u)}if(T||(w=t._gsap,w.renderTransform&&!e.parseTransform||Wr(t,e.parseTransform),b=e.smoothOrigin!==!1&&w.smooth,T=this._pt=new Fe(this._pt,o,re,0,1,w.renderTransform,w,0,-1),T.dep=1),_==="scale")this._pt=new Fe(this._pt,w,"scaleY",w.scaleY,(y?lr(w.scaleY,y+d):d)-w.scaleY||0,qo),this._pt.u=0,a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){C.push(Be,0,o[Be]),u=z0(u),w.svg?Ko(t,u,0,b,0,this):(p=parseFloat(u.split(" ")[2])||0,p!==w.zOrigin&&Jn(this,w,"zOrigin",w.zOrigin,p),Jn(this,o,_,Zs(c),Zs(u)));continue}else if(_==="svgOrigin"){Ko(t,u,1,b,0,this);continue}else if(_ in zh){G0(this,w,_,h,y?lr(h,y+u):u);continue}else if(_==="smoothOrigin"){Jn(this,w,"smooth",w.smooth,u);continue}else if(_==="force3D"){w[_]=u;continue}else if(_==="transform"){W0(this,u,t);continue}}else _ in o||(_=Mr(_)||_);if(v||(d||d===0)&&(h||h===0)&&!T0.test(u)&&_ in o)f=(c+"").substr((h+"").length),d||(d=0),p=Ae(u)||(_ in Ke.units?Ke.units[_]:f),f!==p&&(h=oi(t,_,c,p)),this._pt=new Fe(this._pt,v?w:o,_,h,(y?lr(h,y+d):d)-h,!v&&(p==="px"||_==="zIndex")&&e.autoRound!==!1?C0:qo),this._pt.u=p||0,v&&M!==u?(this._pt.b=c,this._pt.e=M,this._pt.r=w0):f!==p&&p!=="%"&&(this._pt.b=c,this._pt.r=b0);else if(_ in o)B0.call(this,t,_,c,y?y+u:u);else if(_ in t)this.add(t,_,c||t[_],y?y+u:u,i,s);else if(_!=="parseTransform"){_l(_,u);continue}v||(_ in o?C.push(_,0,o[_]):typeof t[_]=="function"?C.push(_,2,t[_]()):C.push(_,1,c||t[_])),a.push(_)}}A&&Ph(this)},render:function(t,e){if(e.tween._time||!wl())for(var n=e._pt;n;)n.r(t,n.d),n=n._next;else e.styles.revert()},get:Dn,aliases:Mn,getSetter:function(t,e,n){var i=Mn[e];return i&&i.indexOf(",")<0&&(e=i),e in kn&&e!==Be&&(t._gsap.x||Dn(t,"x"))?n&&qc===n?e==="scale"?D0:L0:(qc=n||{})&&(e==="scale"?I0:U0):t.style&&!fl(t.style[e])?R0:~e.indexOf("-")?P0:Tl(t,e)},core:{_removeProperty:ai,_getMatrix:Rl}};ze.utils.checkPrefix=Mr;ze.core.getStyleSaver=Nh;(function(r,t,e,n){var i=Oe(r+","+t+","+e,function(s){kn[s]=1});Oe(t,function(s){Ke.units[s]="deg",zh[s]=1}),Mn[i[13]]=r+","+t,Oe(n,function(s){var a=s.split(":");Mn[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");Oe("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){Ke.units[r]="px"});ze.registerPlugin(Vh);var Gh=ze.registerPlugin(Vh)||ze;Gh.core.Tween;function X0(r){const t=document.querySelectorAll(".intro-title .brush-text"),e=document.querySelector(".intro-subtitle"),n=document.querySelector(".intro-quote"),i=document.querySelector(".intro-desc");t.forEach(a=>{const o=a.getComputedTextLength();a.style.strokeDasharray=o,a.style.strokeDashoffset=o,a.style.fill="transparent"}),Gh.timeline({delay:.8}).to(t,{strokeDashoffset:0,fill:"#f5f0e6",duration:2.5,stagger:.4,ease:"power2.inOut"}).to(e,{opacity:1,y:0,duration:1,ease:"power2.out"},"-=1").to(n,{opacity:1,y:0,duration:1,ease:"power2.out"},"-=0.6").to(i,{opacity:1,y:0,duration:1,ease:"power2.out"},"-=0.6")}async function q0(){const r=await fetch("/data/content.json");if(!r.ok)throw new Error(`Failed to load content: ${r.status}`);return r.json()}function Y0(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function eu(){return window.matchMedia("(pointer: coarse)").matches||window.innerWidth<768}const jo="https://ncm-api-ochre.vercel.app",nu="12675557343";let Ce=[],Sn=-1,$t=null,ii=!1,Ai=!1,Js=!1,Nn,ca,On,Wh,Pl,Xh,qh,Yh,Zo,$h,Kh,jh,Zh,Jo,Qs,ta;function $0(){K0(),j0()}function K0(){const r=document.createElement("div");r.className="music-widget",r.innerHTML=`
    ...
    <button class="music-btn" id="musicBtn" title="音乐播放器">
      ...
      </div>`}).join(""),On.querySelectorAll(".music-list-item").forEach(r=>{r.addEventListener("click",()=>{const t=parseInt(r.dataset.index);Ce[t]&&ua(t)})})}function Bs(){On.querySelectorAll(".music-list-item").forEach((t,e)=>{t.classList.toggle("active",e===Sn);const n=t.querySelector(".music-item-num");e===Sn&&ii?n.innerHTML='<span class="music-eq"><span></span><span></span><span></span></span>':n.textContent=e+1}),Pl.innerHTML=ii?'<svg viewBox="0 0 24 24" width="20" height="20"><path fill="currentColor" d="M6 19h4V5H6v14zm8-14v14h4V5h-4z"/></svg>':'<svg viewBox="0 0 24 24" width="20" height="20"><path fill="currentColor" d="M8 5v14l11-7z"/></svg>',Qh()}function Qh(){if(Wh.style.display=Ce.length>0?"":"none",Sn>=0&&Ce[Sn]){const r=Ce[Sn];Qs.textContent=r.name||"—",ta.textContent=r.ar?r.ar.map(t=>t.name).join(" / "):""}else Qs.textContent="—",ta.textContent=""}function nx(r){Qs.textContent=r.name||"—",ta.textContent=r.ar?r.ar.map(t=>t.name).join(" / "):""}async function ua(r){if(r<0||r>=Ce.length)return;$t&&($t.pause(),$t.src=""),Sn=r,ii=!1,Bs();const t=Ce[r];nx(t);const e=On.querySelector(`[data-index="${r}"]`);e&&e.classList.add("loading");let n;try{n=await tx(t.id)}catch{e&&e.classList.remove("loading"),ru();return}e&&e.classList.remove("loading"),$t=new Audio(n),$t.addEventListener("canplay",()=>{ii=!0,$t.play().catch(()=>{}),Bs()}),$t.addEventListener("ended",()=>td()),$t.addEventListener("timeupdate",()=>{if($t&&$t.duration){const i=$t.currentTime/$t.duration*100;Yh.style.width=i+"%",$h.textContent=Qo($t.currentTime)}}),$t.addEventListener("loadedmetadata",()=>{Kh.textContent=Qo($t.duration)}),$t.addEventListener("error",()=>{ii=!1,Bs(),ru()}),$t.load()}function iu(){if(!$t&&Ce.length>0){ua(0);return}$t&&(ii?($t.pause(),ii=!1):($t.play().catch(()=>{}),ii=!0),Bs())}function td(){Ce.length!==0&&ua((Sn+1)%Ce.length)}function ix(){if(Ce.length!==0){if($t&&$t.currentTime>2){$t.currentTime=0;return}ua((Sn-1+Ce.length)%Ce.length)}}function ru(){const r=On.querySelector(`[data-index="${Sn}"]`);r&&(r.classList.add("unavailable"),setTimeout(()=>r.classList.remove("unavailable"),2e3))}function Qo(r){if(!r||isNaN(r))return"0:00";const t=Math.floor(r/60),e=Math.floor(r%60);return`${t}:${e<10?"0":""}${e}`}function su(r){const t=document.createElement("div");return t.textContent=r,t.innerHTML}let Nr=[];function rx(){const r=document.getElementById("notesGrid");r&&sx().then(()=>ax(r))}async function sx(){try{Nr=(await(await fetch("/data/content.json")).json()).notes||[]}catch{Nr=[]}}function ax(r){r.innerHTML=Nr.length===0?'<div class="note-empty">暂无笔记</div>':Nr.map(t=>{var e;return`
      ...
      </div>`}).join(""),r.querySelectorAll(".note-card").forEach(t=>{t.addEventListener("click",()=>{const e=Nr.find(n=>n.id===t.dataset.note);e&&ox(e)})})}function ox(r){const t=document.createElement("div");t.className="note-overlay",t.innerHTML=`
    <div class="note-modal">
      ...
      <div class="note-modal-body">${lx(r.content)}</div>
    </div>`,document.body.appendChild(t);const e=()=>t.remove();t.querySelector(".note-modal-close").addEventListener("click",e),t.addEventListener("click",n=>{n.target===t&&e()})}function lx(r){return ea(r).split(`
`).filter(t=>t.trim()).map(t=>`<p>${t}</p>`).join("")}function ea(r){const t=document.createElement("div");return t.textContent=r,t.innerHTML}function cx(){const r=document.createElement("div");r.className="note-overlay",r.innerHTML=`
...
`)],{type:"text/plain"}),p=document.createElement("a");p.href=URL.createObjectURL(f),p.download="gmail_aliases.txt",p.click(),URL.revokeObjectURL(p.href)})}const Xr="https://next-app-one-navy.vercel.app";function ux(){const r=document.getElementById("messageBoard");r&&tl(r)}async function tl(r){r.innerHTML='<div class="msg-loading"><div class="ink-spinner"></div></div>';try{const n=(await(await fetch(`${Xr}/api/messages`)).json()).messages||[];r.innerHTML=`
      ...
      <div class="msg-list">
        ...
        ${n.map(i=>`
          <div class="msg-item">
            <div class="msg-meta">
              <span class="msg-name">${au(i.name)}</span>
              <span class="msg-time">${px(i.time)}</span>
            </div>
            <div class="msg-content">${au(i.message)}</div>
          </div>`).join("")}
      </div>`,r.querySelector("#msgForm").addEventListener("submit",async i=>{i.preventDefault();const s=r.querySelector("#msgName").value.trim(),a=r.querySelector("#msgText").value.trim();if(!s||!a)return;const o=r.querySelector(".msg-submit");o.disabled=!0,o.textContent="发送中…";try{const l=await fetch(`${Xr}/api/messages`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:s,message:a})});if(!l.ok)throw new Error(`HTTP ${l.status}`);tl(r)}catch{o.textContent="发送失败，重试",o.disabled=!1}})}catch{r.innerHTML='<div class="msg-error">加载失败，点击重试</div>',r.querySelector(".msg-error").addEventListener("click",()=>tl(r))}}function hx(){const r=document.getElementById("contactForm");r&&r.addEventListener("submit",async t=>{t.preventDefault();const e=r.querySelector(".contact-submit"),n=e.textContent;e.disabled=!0,e.textContent="发送中…";try{await fetch(`${Xr}/api/contact`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:r.querySelector("#contactName").value,email:r.querySelector("#contactEmail").value,subject:r.querySelector("#contactSubject").value,message:r.querySelector("#contactMessage").value})}),e.textContent="已发送，感谢！",r.reset(),setTimeout(()=>{e.textContent=n,e.disabled=!1},3e3)}catch{e.textContent="发送失败，重试",e.disabled=!1}})}function dx(){fetch(`${Xr}/api/stats`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({type:"visit"})}).catch(()=>{})}async function fx(r){try{const e=await(await fetch(`${Xr}/api/stats`)).json();r.innerHTML=`
...
`),e=new Blob([t],{type:"text/plain;charset=utf-8"}),n=URL.createObjectURL(e),i=document.createElement("a");i.href=n,i.download=`灵犀对话-${new Date().toISOString().slice(0,10)}.txt`,document.body.appendChild(i),i.click(),document.body.removeChild(i),URL.revokeObjectURL(n)}function uu(r,t){if(r.innerHTML="",t.length===0){r.innerHTML=`
      <div class="chat-empty">
        <div class="chat-empty-title">✦ 灵犀初启</div>
        <div class="chat-empty-sub">温若在此，想问什么？</div>
      </div>`;return}t.forEach(e=>rd(r,e)),ts(r)}function rd(r,t){const e=r.querySelector(".chat-empty");e&&e.remove();const n=document.createElement("div");n.className=`chat-message chat-message-${t.role}`,n.innerHTML=`
    ...
    <div class="chat-bubble"><div class="chat-text"></div><span class="chat-cursor"></span></div>`,r.appendChild(n),ts(r)}function hu(r,t){const e=document.getElementById(r);if(!e)return;const n=e.querySelector(".chat-text");n&&(n.textContent=t);const i=document.getElementById("chatMessages");ts(i)}function Qa(r,t){const e=document.getElementById(r);if(!e)return;e.classList.remove("streaming");const n=e.querySelector(".chat-cursor");n&&n.remove();const i=e.querySelector(".chat-text");i&&(i.textContent=t)}function ts(r){r&&(r.scrollTop=r.scrollHeight)}function Ax(){try{const r=localStorage.getItem(id),t=r?JSON.parse(r):{};return{messages:Array.isArray(t.messages)?t.messages:[],model:t.model||lu,temperature:typeof t.temperature=="number"?t.temperature:ou,maxTokens:t.maxTokens||el,ocMode:typeof t.ocMode=="boolean"?t.ocMode:cu}}catch{return{messages:[],model:lu,temperature:ou,maxTokens:el,ocMode:cu}}}function xi(r){try{localStorage.setItem(id,JSON.stringify(r))}catch{}}function nl(r){const t=document.createElement("div");return t.textContent=r,t.innerHTML}function bx(r){!r||r.tagName!=="TEXTAREA"||r.addEventListener("input",()=>{r.style.height="auto",r.style.height=Math.min(r.scrollHeight,160)+"px"})}async function wx(){Av(document.getElementById("bg-image"));const r=await q0();document.querySelector(".intro-subtitle").textContent=r.intro.subtitle,document.querySelector(".intro-quote").textContent=r.intro.quote,document.querySelector(".intro-desc").textContent=r.intro.desc,Cx(document.querySelector(".intro-quote"),r.intro.quote),document.title=r.site.title;const t=document.getElementById("webgl-bg"),e=document.getElementById("cursor-aura");let n=null,i=null,s=null,a=null;if(!Y0())try{n=new Mv(t),i=new Sv(n.scene,{count:eu()?3:6}),eu()||(s=new yv(e));const o=new qu,l=()=>{const c=o.getElapsedTime(),u=window.scrollY/(document.body.scrollHeight-window.innerHeight);n.animate(),i&&i.update(c,u),a=requestAnimationFrame(l)};l()}catch(o){console.warn("WebGL effects unavailable, falling back to static content:",o),t.style.background="radial-gradient(ellipse at center, #1a1f18 0%, #0c0f0a 100%)"}return X0(r.intro),$0(),Rx(),rx(),Px(),ux(),hx(),_x(),dx(),fx(document.getElementById("statsBar")),()=>{a&&cancelAnimationFrame(a),n&&n.destroy(),s&&s.destroy()}}async function Cx(r,t){try{const e=await fetch("https://v1.hitokoto.cn");if(!e.ok)throw new Error("Hitokoto API error");const n=await e.json();n&&n.hitokoto&&(r.textContent=n.hitokoto)}catch(e){console.warn("Hitokoto load failed:",e),r.textContent=t}}function Rx(){const r=document.querySelectorAll(".ios-nav-tab"),t=document.querySelectorAll(".page"),e=document.querySelector(".ios-nav-inner");if(r.forEach(n=>{n.addEventListener("click",()=>{const i=n.dataset.page;r.forEach(s=>s.classList.remove("active")),n.classList.add("active"),t.forEach(s=>{s.classList.toggle("active",s.id===`page-${i}`)}),window.scrollTo({top:0,behavior:"smooth"})})}),e){const n=()=>{e.classList.toggle("scrolled",window.scrollY>10)};window.addEventListener("scroll",n,{passive:!0}),n()}}function Px(){const r=document.querySelector('[data-tool="gmail-alias"]');r&&r.addEventListener("click",()=>cx())}wx().catch(r=>{console.error("Failed to initialize app:",r)});
//# sourceMappingURL=index-D9aWM8FM.js.map
