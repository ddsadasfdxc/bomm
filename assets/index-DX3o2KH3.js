...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Qn,depthTest:!1,depthWrite:!1})}function _c(){return new yn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:dl(),fragmentShader:`
		...
		`,blending:Qn,depthTest:!1,depthWrite:!1})}function gc(){return new yn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:dl(),fragmentShader:`
...
#define LOW_PRECISION`),t}function Ng(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===pu?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===fd?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===Pn&&(t="SHADOWMAP_TYPE_VSM"),t}function Og(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case hr:case dr:t="ENVMAP_TYPE_CUBE";break;case na:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Fg(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case dr:t="ENVMAP_MODE_REFRACTION";break}return t}function Bg(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case mu:t="ENVMAP_BLENDING_MULTIPLY";break;case zd:t="ENVMAP_BLENDING_MIX";break;case kd:t="ENVMAP_BLENDING_ADD";break}return t}function zg(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function kg(r,t,e,n){const i=r.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Ng(e),c=Og(e),u=Fg(e),d=Bg(e),h=zg(e),m=wg(e),g=Cg(s),_=i.createProgram();let f,p,y=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(Rr).join(`
`),p=[Pc(e),"#define SHADER_TYPE "+e.shaderType,"#define SHADER_NAME "+e.shaderName,g,e.useFog&&e.fog?"#define USE_FOG":"",e.useFog&&e.fogExp2?"#define FOG_EXP2":"",e.alphaToCoverage?"#define ALPHA_TO_COVERAGE":"",e.map?"#define USE_MAP":"",e.matcap?"#define USE_MATCAP":"",e.envMap?"#define USE_ENVMAP":"",e.envMap?"#define "+c:"",e.envMap?"#define "+u:"",e.envMap?"#define "+d:"",h?"#define CUBEUV_TEXEL_WIDTH "+h.texelWidth:"",h?"#define CUBEUV_TEXEL_HEIGHT "+h.texelHeight:"",h?"#define CUBEUV_MAX_MIP "+h.maxMip+".0":"",e.lightMap?"#define USE_LIGHTMAP":"",e.aoMap?"#define USE_AOMAP":"",e.bumpMap?"#define USE_BUMPMAP":"",e.normalMap?"#define USE_NORMALMAP":"",e.normalMapObjectSpace?"#define USE_NORMALMAP_OBJECTSPACE":"",e.normalMapTangentSpace?"#define USE_NORMALMAP_TANGENTSPACE":"",e.emissiveMap?"#define USE_EMISSIVEMAP":"",e.anisotropy?"#define USE_ANISOTROPY":"",e.anisotropyMap?"#define USE_ANISOTROPYMAP":"",e.clearcoat?"#define USE_CLEARCOAT":"",e.clearcoatMap?"#define USE_CLEARCOATMAP":"",e.clearcoatRoughnessMap?"#define USE_CLEARCOAT_ROUGHNESSMAP":"",e.clearcoatNormalMap?"#define USE_CLEARCOAT_NORMALMAP":"",e.dispersion?"#define USE_DISPERSION":"",e.iridescence?"#define USE_IRIDESCENCE":"",e.iridescenceMap?"#define USE_IRIDESCENCEMAP":"",e.iridescenceThicknessMap?"#define USE_IRIDESCENCE_THICKNESSMAP":"",e.specularMap?"#define USE_SPECULARMAP":"",e.specularColorMap?"#define USE_SPECULAR_COLORMAP":"",e.specularIntensityMap?"#define USE_SPECULAR_INTENSITYMAP":"",e.roughnessMap?"#define USE_ROUGHNESSMAP":"",e.metalnessMap?"#define USE_METALNESSMAP":"",e.alphaMap?"#define USE_ALPHAMAP":"",e.alphaTest?"#define USE_ALPHATEST":"",e.alphaHash?"#define USE_ALPHAHASH":"",e.sheen?"#define USE_SHEEN":"",e.sheenColorMap?"#define USE_SHEEN_COLORMAP":"",e.sheenRoughnessMap?"#define USE_SHEEN_ROUGHNESSMAP":"",e.transmission?"#define USE_TRANSMISSION":"",e.transmissionMap?"#define USE_TRANSMISSIONMAP":"",e.thicknessMap?"#define USE_THICKNESSMAP":"",e.vertexTangents&&e.flatShading===!1?"#define USE_TANGENT":"",e.vertexColors||e.instancingColor||e.batchingColor?"#define USE_COLOR":"",e.vertexAlphas?"#define USE_COLOR_ALPHA":"",e.vertexUv1s?"#define USE_UV1":"",e.vertexUv2s?"#define USE_UV2":"",e.vertexUv3s?"#define USE_UV3":"",e.pointsUvs?"#define USE_POINTS_UV":"",e.gradientMap?"#define USE_GRADIENTMAP":"",e.flatShading?"#define FLAT_SHADED":"",e.doubleSided?"#define DOUBLE_SIDED":"",e.flipSided?"#define FLIP_SIDED":"",e.shadowMapEnabled?"#define USE_SHADOWMAP":"",e.shadowMapEnabled?"#define "+l:"",e.premultipliedAlpha?"#define PREMULTIPLIED_ALPHA":"",e.numLightProbes>0?"#define USE_LIGHT_PROBES":"",e.decodeVideoTexture?"#define DECODE_VIDEO_TEXTURE":"",e.logarithmicDepthBuffer?"#define USE_LOGDEPTHBUF":"","uniform mat4 viewMatrix;","uniform vec3 cameraPosition;","uniform bool isOrthographic;",e.toneMapping!==ti?"#define TONE_MAPPING":"",e.toneMapping!==ti?Dt.tonemapping_pars_fragment:"",e.toneMapping!==ti?Ag("toneMapping",e.toneMapping):"",e.dithering?"#define DITHERING":"",e.opaque?"#define OPAQUE":"",Dt.colorspace_pars_fragment,bg("linearToOutputTexel",e.outputColorSpace),e.useDepthPacking?"#define DEPTH_PACKING "+e.depthPacking:"",`
`].filter(Rr).join(`
`)),a=No(a),a=wc(a,e),a=Cc(a,e),o=No(o),o=wc(o,e),o=Cc(o,e),a=Rc(a),o=Rc(o),e.isRawShaderMaterial!==!0&&(y=`#version 300 es
`,f=[m,"#define attribute in","#define varying out","#define texture2D texture"].join(`
`)+`
`+f,p=["#define varying in",e.glslVersion===Xl?"":"layout(location = 0) out highp vec4 pc_fragColor;",e.glslVersion===Xl?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
`+p);const v=y+f+a,T=y+p+o,w=bc(i,i.VERTEX_SHADER,v),A=bc(i,i.FRAGMENT_SHADER,T);i.attachShader(_,w),i.attachShader(_,A),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function b(P){if(r.debug.checkShaderErrors){const k=i.getProgramInfoLog(_).trim(),N=i.getShaderInfoLog(w).trim(),X=i.getShaderInfoLog(A).trim();let V=!0,G=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(V=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,w,A);else{const q=Ac(i,w,"vertex"),H=Ac(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `});return new Sv(e,a)}animate(){this.particles.material.uniforms.uTime.value=this.clock.getElapsedTime(),this.renderer.render(this.scene,this.camera)}onResize(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight)}destroy(){window.removeEventListener("resize",this.resizeHandler),this.renderer.dispose(),this.container.removeChild(this.renderer.domElement)}}class Ev{constructor(t,e={}){this.scene=t,this.count=e.count||6,this.planes=[],this.createClouds()}createClouds(){const t=new Jr(120,40,32,16),e=new yn({transparent:!0,side:_n,depthWrite:!1,uniforms:{uColor:{value:new kt(5995126)},uOpacity:{value:.08}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
*/var Ke={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},Fr={duration:.5,overwrite:!1,delay:0},fl,ye,te,rn=1e8,jt=1/rn,Fo=Math.PI*2,Cv=Fo/4,Rv=0,ju=Math.sqrt,Pv=Math.cos,Lv=Math.sin,xe=function(t){return typeof t=="string"},le=function(t){return typeof t=="function"},zn=function(t){return typeof t=="number"},pl=function(t){return typeof t>"u"},En=function(t){return typeof t=="object"},Ne=function(t){return t!==!1},ml=function(){return typeof window<"u"},Cs=function(t){return le(t)||xe(t)},Zu=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},Ae=Array.isArray,Dv=/random\([^)]+\)/g,Iv=/,\s*/g,Bc=/(?:-?\.?\d|\.)+/gi,Ju=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,ir=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,Ga=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,Qu=/[+-]=-?[.\d]+/,Uv=/[^,'"\[\]\s]+/gi,Nv=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,ie,pn,Bo,_l,je={},Xs={},th,eh=function(t){return(Xs=_r(t,je))&&ze},gl=function(t,e){return console.warn("Invalid property",t,"set to",e,"Missing plugin? gsap.registerPlugin()")},Br=function(t,e){return!e&&console.warn(t)},nh=function(t,e){return t&&(je[t]=e)&&Xs&&(Xs[t]=e)||je},zr=function(){return 0},Ov={suppressEvents:!0,isStart:!0,kill:!1},Ns={suppressEvents:!0,kill:!1},Fv={suppressEvents:!0},vl={},ei=[],zo={},ih,We={},Wa={},zc=30,Os=[],xl="",Ml=function(t){var e=t[0],n,i;if(En(e)||le(e)||(t=[t]),!(n=(e._gsap||{}).harness)){for(i=Os.length;i--&&!Os[i].targetTest(e););n=Os[i]}for(i=t.length;i--;)t[i]&&(t[i]._gsap||(t[i]._gsap=new bh(t[i],n)))||t.splice(i,1);return t},Pi=function(t){return t._gsap||Ml(sn(t))[0]._gsap},rh=function(t,e,n){return(n=t[e])&&le(n)?t[e]():pl(n)&&t.getAttribute&&t.getAttribute(e)||n},Oe=function(t,e){return(t=t.split(",")).forEach(e)||t},ce=function(t){return Math.round(t*1e5)/1e5||0},ne=function(t){return Math.round(t*1e7)/1e7||0},lr=function(t,e){var n=e.charAt(0),i=parseFloat(e.substr(2));return t=parseFloat(t),n==="+"?t+i:n==="-"?t-i:n==="*"?t*i:t/i},Bv=function(t,e){for(var n=e.length,i=0;t.indexOf(e[i])<0&&++i<n;);return i<n},qs=function(){var t=ei.length,e=ei.slice(0),n,i;for(zo={},ei.length=0,n=0;n<t;n++)i=e[n],i&&i._lazy&&(i.render(i._lazy[0],i._lazy[1],!0)._lazy=0)},Sl=function(t){return!!(t._initted||t._startAt||t.add)},sh=function(t,e,n,i){ei.length&&!ye&&qs(),t.render(e,n,!!(ye&&e<0&&Sl(t))),ei.length&&!ye&&qs()},ah=function(t){var e=parseFloat(t);return(e||e===0)&&(t+"").match(Uv).length<2?e:xe(t)?t.trim():t},oh=function(t){return t},Ze=function(t,e){for(var n in e)n in t||(t[n]=e[n]);return t},zv=function(t){return function(e,n){for(var i in n)i in e||i==="duration"&&t||i==="ease"||(e[i]=n[i])}},_r=function(t,e){for(var n in e)t[n]=e[n];return t},kc=function r(t,e){for(var n in e)n!=="__proto__"&&n!=="constructor"&&n!=="prototype"&&(t[n]=En(e[n])?r(t[n]||(t[n]={}),e[n]):e[n]);return t},Ys=function(t,e){var n={},i;for(i in t)i in e||(n[i]=t[i]);return n},Dr=function(t){var e=t.parent||ie,n=t.keyframes?zv(Ae(t.keyframes)):Ze;if(Ne(t.inherit))for(;e;)n(t,e.vars.defaults),e=e.parent||e._dp;return t},kv=function(t,e){for(var n=t.length,i=n===e.length;i&&n--&&t[n]===e[n];);return n<0},lh=function(t,e,n,i,s){var a=t[i],o;if(s)for(o=e[s];a&&a[s]>o;)a=a._prev;return a?(e._next=a._next,a._next=e):(e._next=t[n],t[n]=e),e._next?e._next._prev=e:t[i]=e,e._prev=a,e.parent=e._dp=t,e},aa=function(t,e,n,i){n===void 0&&(n="_first"),i===void 0&&(i="_last");var s=e._prev,a=e._next;s?s._next=a:t[n]===e&&(t[n]=a),a?a._prev=s:t[i]===e&&(t[i]=s),e._next=e._prev=e.parent=null},si=function(t,e){t.parent&&(!e||t.parent.autoRemoveChildren)&&t.parent.remove&&t.parent.remove(t),t._act=0},Li=function(t,e){if(t&&(!e||e._end>t._dur||e._start<0))for(var n=t;n;)n._dirty=1,n=n.parent;return t},Hv=function(t){for(var e=t.parent;e&&e.parent;)e._dirty=1,e.totalDuration(),e=e.parent;return t},ko=function(t,e,n,i){return t._startAt&&(ye?t._startAt.revert(Ns):t.vars.immediateRender&&!t.vars.autoRevert||t._startAt.render(e,!0,i))},Vv=function r(t){return!t||t._ts&&r(t.parent)},Hc=function(t){return t._repeat?gr(t._tTime,t=t.duration()+t._rDelay)*t:0},gr=function(t,e){var n=Math.floor(t=ne(t/e));return t&&n===t?n-1:n},$s=function(t,e){return(t-e._start)*e._ts+(e._ts>=0?0:e._dirty?e.totalDuration():e._tDur)},oa=function(t){return t._end=ne(t._start+(t._tDur/Math.abs(t._ts||t._rts||jt)||0))},la=function(t,e){var n=t._dp;return n&&n.smoothChildTiming&&t._ts&&(t._start=ne(n._time-(t._ts>0?e/t._ts:((t._dirty?t.totalDuration():t._tDur)-e)/-t._ts)),oa(t),n._dirty||Li(n,t)),t},ch=function(t,e){var n;if((e._time||!e._dur&&e._initted||e._start<t._time&&(e._dur||!e.add))&&(n=$s(t.rawTime(),e),(!e._dur||Qr(0,e.totalDuration(),n)-e._tTime>jt)&&e.render(n,!0)),Li(t,e)._dp&&t._initted&&t._time>=t._dur&&t._ts){if(t._dur<t.duration())for(n=t;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;t._zTime=-jt}},vn=function(t,e,n,i){return e.parent&&si(e),e._start=ne((zn(n)?n:n||t!==ie?tn(t,n,e):t._time)+e._delay),e._end=ne(e._start+(e.totalDuration()/Math.abs(e.timeScale())||0)),lh(t,e,"_first","_last",t._sort?"_start":0),Ho(e)||(t._recent=e),i||ch(t,e),t._ts<0&&la(t,t._tTime),t},uh=function(t,e){return(je.ScrollTrigger||gl("scrollTrigger",e))&&je.ScrollTrigger.create(e,t)},hh=function(t,e,n,i,s){if(El(t,e,s),!t._initted)return 1;if(!n&&t._pt&&!ye&&(t._dur&&t.vars.lazy!==!1||!t._dur&&t.vars.lazy)&&ih!==Xe.frame)return ei.push(t),t._lazy=[s,i],1},Gv=function r(t){var e=t.parent;return e&&e._ts&&e._initted&&!e._lock&&(e.rawTime()<0||r(e))},Ho=function(t){var e=t.data;return e==="isFromStart"||e==="isStart"},Wv=function(t,e,n,i){var s=t.ratio,a=e<0||!e&&(!t._start&&Gv(t)&&!(!t._initted&&Ho(t))||(t._ts<0||t._dp._ts<0)&&!Ho(t))?0:1,o=t._rDelay,l=0,c,u,d;if(o&&t._repeat&&(l=Qr(0,t._tDur,e),u=gr(l,o),t._yoyo&&u&1&&(a=1-a),u!==gr(t._tTime,o)&&(s=1-a,t.vars.repeatRefresh&&t._initted&&t.invalidate())),a!==s||ye||i||t._zTime===jt||!e&&t._zTime){if(!t._initted&&hh(t,e,i,n,l))return;for(d=t._zTime,t._zTime=e||(n?jt:0),n||(n=e&&!d),t.ratio=a,t._from&&(a=1-a),t._time=0,t._tTime=l,c=t._pt;c;)c.r(a,c.d),c=c._next;e<0&&ko(t,e,n,!0),t._onUpdate&&!n&&qe(t,"onUpdate"),l&&t._repeat&&!n&&t.parent&&qe(t,"onRepeat"),(e>=t._tDur||e<0)&&t.ratio===a&&(a&&si(t,1),!n&&!ye&&(qe(t,a?"onComplete":"onReverseComplete",!0),t._prom&&t._prom()))}else t._zTime||(t._zTime=e)},Xv=function(t,e,n){var i;if(n>e)for(i=t._first;i&&i._start<=n;){if(i.data==="isPause"&&i._start>e)return i;i=i._next}else for(i=t._last;i&&i._start>=n;){if(i.data==="isPause"&&i._start<e)return i;i=i._prev}},vr=function(t,e,n,i){var s=t._repeat,a=ne(e)||0,o=t._tTime/t._tDur;return o&&!i&&(t._time*=a/t._dur),t._dur=a,t._tDur=s?s<0?1e10:ne(a*(s+1)+t._rDelay*s):a,o>0&&!i&&la(t,t._tTime=t._tDur*o),t.parent&&oa(t),n||Li(t.parent,t),t},Vc=function(t){return t instanceof Le?Li(t):vr(t,t._dur)},qv={_start:0,endTime:zr,totalDuration:zr},tn=function r(t,e,n){var i=t.labels,s=t._recent||qv,a=t.duration()>=rn?s.endTime(!1):t._dur,o,l,c;return xe(e)&&(isNaN(e)||e in i)?(l=e.charAt(0),c=e.substr(-1)==="%",o=e.indexOf("="),l==="<"||l===">"?(o>=0&&(e=e.replace(/=/,"")),(l==="<"?s._start:s.endTime(s._repeat>=0))+(parseFloat(e.substr(1))||0)*(c?(o<0?s:n).totalDuration()/100:1)):o<0?(e in i||(i[e]=a),i[e]):(l=parseFloat(e.charAt(o-1)+e.substr(o+1)),c&&n&&(l=l/100*(Ae(n)?n[0]:n).totalDuration()),o>1?r(t,e.substr(0,o-1),n)+l:a+l)):e==null?a:+e},Ir=function(t,e,n){var i=zn(e[1]),s=(i?2:1)+(t<2?0:1),a=e[s],o,l;if(i&&(a.duration=e[1]),a.parent=n,t){for(o=a,l=n;l&&!("immediateRender"in o);)o=l.vars.defaults||{},l=Ne(l.vars.inherit)&&l.parent;a.immediateRender=Ne(o.immediateRender),t<2?a.runBackwards=1:a.startAt=e[s-1]}return new fe(e[0],a,e[s+1])},ci=function(t,e){return t||t===0?e(t):e},Qr=function(t,e,n){return n<t?t:n>e?e:n},be=function(t,e){return!xe(t)||!(e=Nv.exec(t))?"":e[1]},Yv=function(t,e,n){return ci(n,function(i){return Qr(t,e,i)})},Vo=[].slice,dh=function(t,e){return t&&En(t)&&"length"in t&&(!e&&!t.length||t.length-1 in t&&En(t[0]))&&!t.nodeType&&t!==pn},$v=function(t,e,n){return n===void 0&&(n=[]),t.forEach(function(i){var s;return xe(i)&&!e||dh(i,1)?(s=n).push.apply(s,sn(i)):n.push(i)})||n},sn=function(t,e,n){return te&&!e&&te.selector?te.selector(t):xe(t)&&!n&&(Bo||!xr())?Vo.call((e||_l).querySelectorAll(t),0):Ae(t)?$v(t,n):dh(t)?Vo.call(t,0):t?[t]:[]},Go=function(t){return t=sn(t)[0]||Br("Invalid scope")||{},function(e){var n=t.current||t.nativeElement||t;return sn(e,n.querySelectorAll?n:n===t?Br("Invalid scope")||_l.createElement("div"):t)}},fh=function(t){return t.sort(function(){return .5-Math.random()})},ph=function(t){if(le(t))return t;var e=En(t)?t:{each:t},n=Di(e.ease),i=e.from||0,s=parseFloat(e.base)||0,a={},o=i>0&&i<1,l=isNaN(i)||o,c=e.axis,u=i,d=i;return xe(i)?u=d={center:.5,edges:.5,end:1}[i]||0:!o&&l&&(u=i[0],d=i[1]),function(h,m,g){var _=(g||e).length,f=a[_],p,y,v,T,w,A,b,C,M;if(!f){if(M=e.grid==="auto"?0:(e.grid||[1,rn])[1],!M){for(b=-rn;b<(b=g[M++].getBoundingClientRect().left)&&M<_;);M<_&&M--}for(f=a[_]=[],p=l?Math.min(M,_)*u-.5:i%M,y=M===rn?0:l?_*d/M-.5:i/M|0,b=0,C=rn,A=0;A<_;A++)v=A%M-p,T=y-(A/M|0),f[A]=w=c?Math.abs(c==="y"?T:v):ju(v*v+T*T),w>b&&(b=w),w<C&&(C=w);i==="random"&&fh(f),f.max=b-C,f.min=C,f.v=_=(parseFloat(e.amount)||parseFloat(e.each)*(M>_?_-1:c?c==="y"?_/M:M:Math.max(M,_/M))||0)*(i==="edges"?-1:1),f.b=_<0?s-_:s,f.u=be(e.amount||e.each)||0,n=n&&_<0?o0(n):n}return _=(f[h]-f.min)/f.max||0,ne(f.b+(n?n(_):_)*f.v)+f.u}},Wo=function(t){var e=Math.pow(10,((t+"").split(".")[1]||"").length);return function(n){var i=ne(Math.round(parseFloat(n)/t)*t*e);return(i-i%1)/e+(zn(n)?0:be(n))}},mh=function(t,e){var n=Ae(t),i,s;return!n&&En(t)&&(i=n=t.radius||rn,t.values?(t=sn(t.values),(s=!zn(t[0]))&&(i*=i)):t=Wo(t.increment)),ci(e,n?le(t)?function(a){return s=t(a),Math.abs(s-a)<=i?s:a}:function(a){for(var o=parseFloat(s?a.x:a),l=parseFloat(s?a.y:0),c=rn,u=0,d=t.length,h,m;d--;)s?(h=t[d].x-o,m=t[d].y-l,h=h*h+m*m):h=Math.abs(t[d]-o),h<c&&(c=h,u=d);return u=!i||c<=i?t[u]:a,s||u===a||zn(a)?u:u+be(a)}:Wo(t))},_h=function(t,e,n,i){return ci(Ae(t)?!e:n===!0?!!(n=0):!i,function(){return Ae(t)?t[~~(Math.random()*t.length)]:(n=n||1e-5)&&(i=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((t-n/2+Math.random()*(e-t+n*.99))/n)*n*i)/i})},Kv=function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];return function(i){return e.reduce(function(s,a){return a(s)},i)}},jv=function(t,e){return function(n){return t(parseFloat(n))+(e||be(n))}},Zv=function(t,e,n){return vh(t,e,0,1,n)},gh=function(t,e,n){return ci(n,function(i){return t[~~e(i)]})},Jv=function r(t,e,n){var i=e-t;return Ae(t)?gh(t,r(0,t.length),e):ci(n,function(s){return(i+(s-t)%i)%i+t})},Qv=function r(t,e,n){var i=e-t,s=i*2;return Ae(t)?gh(t,r(0,t.length-1),e):ci(n,function(a){return a=(s+(a-t)%s)%s||0,t+(a>i?s-a:a)})},kr=function(t){return t.replace(Dv,function(e){var n=e.indexOf("[")+1,i=e.substring(n||7,n?e.indexOf("]"):e.length-1).split(Iv);return _h(n?i:+i[0],n?0:+i[1],+i[2]||1e-5)})},vh=function(t,e,n,i,s){var a=e-t,o=i-n;return ci(s,function(l){return n+((l-t)/a*o||0)})},t0=function r(t,e,n,i){var s=isNaN(t+e)?0:function(m){return(1-m)*t+m*e};if(!s){var a=xe(t),o={},l,c,u,d,h;if(n===!0&&(i=1)&&(n=null),a)t={p:t},e={p:e};else if(Ae(t)&&!Ae(e)){for(u=[],d=t.length,h=d-2,c=1;c<d;c++)u.push(r(t[c-1],t[c]));d--,s=function(g){g*=d;var _=Math.min(h,~~g);return u[_](g-_)},n=e}else i||(t=_r(Ae(t)?[]:{},t));if(!u){for(l in e)yl.call(o,t,l,"get",e[l]);s=function(g){return Al(g,o)||(a?t.p:t)}}}return ci(n,s)},Gc=function(t,e,n){var i=t.labels,s=rn,a,o,l;for(a in i)o=i[a]-e,o<0==!!n&&o&&s>(o=Math.abs(o))&&(l=a,s=o);return l},qe=function(t,e,n){var i=t.vars,s=i[e],a=te,o=t._ctx,l,c,u;if(s)return l=i[e+"Params"],c=i.callbackScope||t,n&&ei.length&&qs(),o&&(te=o),u=l?s.apply(c,l):s.call(c),te=a,u},Pr=function(t){return si(t),t.scrollTrigger&&t.scrollTrigger.kill(!!ye),t.progress()<1&&qe(t,"onInterrupt"),t},rr,xh=[],Mh=function(t){if(t)if(t=!t.name&&t.default||t,ml()||t.headless){var e=t.name,n=le(t),i=e&&!n&&t.init?function(){this._props=[]}:t,s={init:zr,render:Al,add:yl,kill:g0,modifier:_0,rawVars:0},a={targetTest:0,get:0,getSetter:bl,aliases:{},register:0};if(xr(),t!==i){if(We[e])return;Ze(i,Ze(Ys(t,s),a)),_r(i.prototype,_r(s,Ys(t,a))),We[i.prop=e]=i,t.targetTest&&(Os.push(i),vl[e]=1),e=(e==="css"?"CSS":e.charAt(0).toUpperCase()+e.substr(1))+"Plugin"}nh(e,i),t.register&&t.register(ze,i,Fe)}else xh.push(t)},Kt=255,Lr={aqua:[0,Kt,Kt],lime:[0,Kt,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,Kt],navy:[0,0,128],white:[Kt,Kt,Kt],olive:[128,128,0],yellow:[Kt,Kt,0],orange:[Kt,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[Kt,0,0],pink:[Kt,192,203],cyan:[0,Kt,Kt],transparent:[Kt,Kt,Kt,0]},Xa=function(t,e,n){return t+=t<0?1:t>1?-1:0,(t*6<1?e+(n-e)*t*6:t<.5?n:t*3<2?e+(n-e)*(2/3-t)*6:e)*Kt+.5|0},Sh=function(t,e,n){var i=t?zn(t)?[t>>16,t>>8&Kt,t&Kt]:0:Lr.black,s,a,o,l,c,u,d,h,m,g;if(!i){if(t.substr(-1)===","&&(t=t.substr(0,t.length-1)),Lr[t])i=Lr[t];else if(t.charAt(0)==="#"){if(t.length<6&&(s=t.charAt(1),a=t.charAt(2),o=t.charAt(3),t="#"+s+s+a+a+o+o+(t.length===5?t.charAt(4)+t.charAt(4):"")),t.length===9)return i=parseInt(t.substr(1,6),16),[i>>16,i>>8&Kt,i&Kt,parseInt(t.substr(7),16)/255];t=parseInt(t.substr(1),16),i=[t>>16,t>>8&Kt,t&Kt]}else if(t.substr(0,3)==="hsl"){if(i=g=t.match(Bc),!e)l=+i[0]%360/360,c=+i[1]/100,u=+i[2]/100,a=u<=.5?u*(c+1):u+c-u*c,s=u*2-a,i.length>3&&(i[3]*=1),i[0]=Xa(l+1/3,s,a),i[1]=Xa(l,s,a),i[2]=Xa(l-1/3,s,a);else if(~t.indexOf("="))return i=t.match(Ju),n&&i.length<4&&(i[3]=1),i}else i=t.match(Bc)||Lr.transparent;i=i.map(Number)}return e&&!g&&(s=i[0]/Kt,a=i[1]/Kt,o=i[2]/Kt,d=Math.max(s,a,o),h=Math.min(s,a,o),u=(d+h)/2,d===h?l=c=0:(m=d-h,c=u>.5?m/(2-d-h):m/(d+h),l=d===s?(a-o)/m+(a<o?6:0):d===a?(o-s)/m+2:(s-a)/m+4,l*=60),i[0]=~~(l+.5),i[1]=~~(c*100+.5),i[2]=~~(u*100+.5)),n&&i.length<4&&(i[3]=1),i},yh=function(t){var e=[],n=[],i=-1;return t.split(ni).forEach(function(s){var a=s.match(ir)||[];e.push.apply(e,a),n.push(i+=a.length+1)}),e.c=n,e},Wc=function(t,e,n){var i="",s=(t+i).match(ni),a=e?"hsla(":"rgba(",o=0,l,c,u,d;if(!s)return t;if(s=s.map(function(h){return(h=Sh(h,e,1))&&a+(e?h[0]+","+h[1]+"%,"+h[2]+"%,"+h[3]:h.join(","))+")"}),n&&(u=yh(t),l=n.c,l.join(i)!==u.c.join(i)))for(c=t.replace(ni,"1").split(ir),d=c.length-1;o<d;o++)i+=c[o]+(~l.indexOf(o)?s.shift()||a+"0,0,0,0)":(u.length?u:s.length?s:n).shift());if(!c)for(c=t.split(ni),d=c.length-1;o<d;o++)i+=c[o]+s[o];return i+c[d]},ni=function(){var r="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",t;for(t in Lr)r+="|"+t+"\\b";return new RegExp(r+")","gi")}(),e0=/hsl[a]?\(/,Eh=function(t){var e=t.join(" "),n;if(ni.lastIndex=0,ni.test(e))return n=e0.test(e),t[1]=Wc(t[1],n),t[0]=Wc(t[0],n,yh(t[1])),!0},Hr,Xe=function(){var r=Date.now,t=500,e=33,n=r(),i=n,s=1e3/240,a=s,o=[],l,c,u,d,h,m,g=function _(f){var p=r()-i,y=f===!0,v,T,w,A;if((p>t||p<0)&&(n+=p-e),i+=p,w=i-n,v=w-a,(v>0||y)&&(A=++d.frame,h=w-d.time*1e3,d.time=w=w/1e3,a+=v+(v>=s?4:s-v),T=1),y||(l=c(_)),T)for(m=0;m<o.length;m++)o[m](w,h,A,f)};return d={time:0,frame:0,tick:function(){g(!0)},deltaRatio:function(f){return h/(1e3/(f||60))},wake:function(){th&&(!Bo&&ml()&&(pn=Bo=window,_l=pn.document||{},je.gsap=ze,(pn.gsapVersions||(pn.gsapVersions=[])).push(ze.version),eh(Xs||pn.GreenSockGlobals||!pn.gsap&&pn||{}),xh.forEach(Mh)),u=typeof requestAnimationFrame<"u"&&requestAnimationFrame,l&&d.sleep(),c=u||function(f){return setTimeout(f,a-d.time*1e3+1|0)},Hr=1,g(2))},sleep:function(){(u?cancelAnimationFrame:clearTimeout)(l),Hr=0,c=zr},lagSmoothing:function(f,p){t=f||1/0,e=Math.min(p||33,t)},fps:function(f){s=1e3/(f||240),a=d.time*1e3+s},add:function(f,p,y){var v=p?function(T,w,A,b){f(T,w,A,b),d.remove(v)}:f;return d.remove(f),o[y?"unshift":"push"](v),xr(),v},remove:function(f,p){~(p=o.indexOf(f))&&o.splice(p,1)&&m>=p&&m--},_listeners:o},d}(),xr=function(){return!Hr&&Xe.wake()},Ot={},n0=/^[\d.\-M][\d.\-,\s]/,i0=/["']/g,r0=function(t){for(var e={},n=t.substr(1,t.length-3).split(":"),i=n[0],s=1,a=n.length,o,l,c;s<a;s++)l=n[s],o=s!==a-1?l.lastIndexOf(","):l.length,c=l.substr(0,o),e[i]=isNaN(c)?c.replace(i0,"").trim():+c,i=l.substr(o+1).trim();return e},s0=function(t){var e=t.indexOf("(")+1,n=t.indexOf(")"),i=t.indexOf("(",e);return t.substring(e,~i&&i<n?t.indexOf(")",n+1):n)},a0=function(t){var e=(t+"").split("("),n=Ot[e[0]];return n&&e.length>1&&n.config?n.config.apply(null,~t.indexOf("{")?[r0(e[1])]:s0(t).split(",").map(ah)):Ot._CE&&n0.test(t)?Ot._CE("",t):n},o0=function(t){return function(e){return 1-t(1-e)}},Di=function(t,e){return t&&(le(t)?t:Ot[t]||a0(t))||e},Oi=function(t,e,n,i){n===void 0&&(n=function(l){return 1-e(1-l)}),i===void 0&&(i=function(l){return l<.5?e(l*2)/2:1-e((1-l)*2)/2});var s={easeIn:e,easeOut:n,easeInOut:i},a;return Oe(t,function(o){Ot[o]=je[o]=s,Ot[a=o.toLowerCase()]=n;for(var l in s)Ot[a+(l==="easeIn"?".in":l==="easeOut"?".out":".inOut")]=Ot[o+"."+l]=s[l]}),s},Th=function(t){return function(e){return e<.5?(1-t(1-e*2))/2:.5+t((e-.5)*2)/2}},qa=function r(t,e,n){var i=e>=1?e:1,s=(n||(t?.3:.45))/(e<1?e:1),a=s/Fo*(Math.asin(1/i)||0),o=function(u){return u===1?1:i*Math.pow(2,-10*u)*Lv((u-a)*s)+1},l=t==="out"?o:t==="in"?function(c){return 1-o(1-c)}:Th(o);return s=Fo/s,l.config=function(c,u){return r(t,c,u)},l},Ya=function r(t,e){e===void 0&&(e=1.70158);var n=function(a){return a?--a*a*((e+1)*a+e)+1:0},i=t==="out"?n:t==="in"?function(s){return 1-n(1-s)}:Th(n);return i.config=function(s){return r(t,s)},i};Oe("Linear,Quad,Cubic,Quart,Quint,Strong",function(r,t){var e=t<5?t+1:t;Oi(r+",Power"+(e-1),t?function(n){return Math.pow(n,e)}:function(n){return n},function(n){return 1-Math.pow(1-n,e)},function(n){return n<.5?Math.pow(n*2,e)/2:1-Math.pow((1-n)*2,e)/2})});Ot.Linear.easeNone=Ot.none=Ot.Linear.easeIn;Oi("Elastic",qa("in"),qa("out"),qa());(function(r,t){var e=1/t,n=2*e,i=2.5*e,s=function(o){return o<e?r*o*o:o<n?r*Math.pow(o-1.5/t,2)+.75:o<i?r*(o-=2.25/t)*o+.9375:r*Math.pow(o-2.625/t,2)+.984375};Oi("Bounce",function(a){return 1-s(1-a)},s)})(7.5625,2.75);Oi("Expo",function(r){return Math.pow(2,10*(r-1))*r+r*r*r*r*r*r*(1-r)});Oi("Circ",function(r){return-(ju(1-r*r)-1)});Oi("Sine",function(r){return r===1?1:-Pv(r*Cv)+1});Oi("Back",Ya("in"),Ya("out"),Ya());Ot.SteppedEase=Ot.steps=je.SteppedEase={config:function(t,e){t===void 0&&(t=1);var n=1/t,i=t+(e?0:1),s=e?1:0,a=1-jt;return function(o){return((i*Qr(0,a,o)|0)+s)*n}}};Fr.ease=Ot["quad.out"];Oe("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(r){return xl+=r+","+r+"Params,"});var bh=function(t,e){this.id=Rv++,t._gsap=this,this.target=t,this.harness=e,this.get=e?e.get:rh,this.set=e?e.getSetter:bl},Vr=function(){function r(e){this.vars=e,this._delay=+e.delay||0,(this._repeat=e.repeat===1/0?-2:e.repeat||0)&&(this._rDelay=e.repeatDelay||0,this._yoyo=!!e.yoyo||!!e.yoyoEase),this._ts=1,vr(this,+e.duration,1,1),this.data=e.data,te&&(this._ctx=te,te.data.push(this)),Hr||Xe.wake()}var t=r.prototype;return t.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},t.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},t.totalDuration=function(n){return arguments.length?(this._dirty=0,vr(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},t.totalTime=function(n,i){if(xr(),!arguments.length)return this._tTime;var s=this._dp;if(s&&s.smoothChildTiming&&this._ts){for(la(this,n),!s._dp||s.parent||ch(s,this);s&&s.parent;)s.parent._time!==s._start+(s._ts>=0?s._tTime/s._ts:(s.totalDuration()-s._tTime)/-s._ts)&&s.totalTime(s._tTime,!0),s=s.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&vn(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!i||this._initted&&Math.abs(this._zTime)===jt||!this._initted&&this._dur&&n||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),sh(this,n,i)),this},t.time=function(n,i){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+Hc(this))%(this._dur+this._rDelay)||(n?this._dur:0),i):this._time},t.totalProgress=function(n,i){return arguments.length?this.totalTime(this.totalDuration()*n,i):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>=0&&this._initted?1:0},t.progress=function(n,i){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+Hc(this),i):this.duration()?Math.min(1,this._time/this._dur):this.rawTime()>0?1:0},t.iteration=function(n,i){var s=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*s,i):this._repeat?gr(this._tTime,s)+1:1},t.timeScale=function(n,i){if(!arguments.length)return this._rts===-jt?0:this._rts;if(this._rts===n)return this;var s=this.parent&&this._ts?$s(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-jt?0:this._rts,this.totalTime(Qr(-Math.abs(this._delay),this.totalDuration(),s),i!==!1),oa(this),Hv(this)},t.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(xr(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==jt&&(this._tTime-=jt)))),this):this._ps},t.startTime=function(n){if(arguments.length){this._start=ne(n);var i=this.parent||this._dp;return i&&(i._sort||!this.parent)&&vn(i,this,this._start-this._delay),this}return this._start},t.endTime=function(n){return this._start+(Ne(n)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},t.rawTime=function(n){var i=this.parent||this._dp;return i?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?$s(i.rawTime(n),this):this._tTime:this._tTime},t.revert=function(n){n===void 0&&(n=Fv);var i=ye;return ye=n,Sl(this)&&(this.timeline&&this.timeline.revert(n),this.totalTime(-.01,n.suppressEvents)),this.data!=="nested"&&n.kill!==!1&&this.kill(),ye=i,this},t.globalTime=function(n){for(var i=this,s=arguments.length?n:i.rawTime();i;)s=i._start+s/(Math.abs(i._ts)||1),i=i._dp;return!this.parent&&this._sat?this._sat.globalTime(n):s},t.repeat=function(n){return arguments.length?(this._repeat=n===1/0?-2:n,Vc(this)):this._repeat===-2?1/0:this._repeat},t.repeatDelay=function(n){if(arguments.length){var i=this._time;return this._rDelay=n,Vc(this),i?this.time(i):this}return this._rDelay},t.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},t.seek=function(n,i){return this.totalTime(tn(this,n),Ne(i))},t.restart=function(n,i){return this.play().totalTime(n?-this._delay:0,Ne(i)),this._dur||(this._zTime=-jt),this},t.play=function(n,i){return n!=null&&this.seek(n,i),this.reversed(!1).paused(!1)},t.reverse=function(n,i){return n!=null&&this.seek(n||this.totalDuration(),i),this.reversed(!0).paused(!1)},t.pause=function(n,i){return n!=null&&this.seek(n,i),this.paused(!0)},t.resume=function(){return this.paused(!1)},t.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-jt:0)),this):this._rts<0},t.invalidate=function(){return this._initted=this._act=0,this._zTime=-jt,this},t.isActive=function(){var n=this.parent||this._dp,i=this._start,s;return!!(!n||this._ts&&this._initted&&n.isActive()&&(s=n.rawTime(!0))>=i&&s<this.endTime(!0)-jt)},t.eventCallback=function(n,i,s){var a=this.vars;return arguments.length>1?(i?(a[n]=i,s&&(a[n+"Params"]=s),n==="onUpdate"&&(this._onUpdate=i)):delete a[n],this):a[n]},t.then=function(n){var i=this,s=i._prom;return new Promise(function(a){var o=le(n)?n:oh,l=function(){var u=i.then;i.then=null,s&&s(),le(o)&&(o=o(i))&&(o.then||o===i)&&(i.then=u),a(o),i.then=u};i._initted&&i.totalProgress()===1&&i._ts>=0||!i._tTime&&i._ts<0?l():i._prom=l})},t.kill=function(){Pr(this)},r}();Ze(Vr.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-jt,_prom:0,_ps:!1,_rts:1});var Le=function(r){Ku(t,r);function t(n,i){var s;return n===void 0&&(n={}),s=r.call(this,n)||this,s.labels={},s.smoothChildTiming=!!n.smoothChildTiming,s.autoRemoveChildren=!!n.autoRemoveChildren,s._sort=Ne(n.sortChildren),ie&&vn(n.parent||ie,Ln(s),i),n.reversed&&s.reverse(),n.paused&&s.paused(!0),n.scrollTrigger&&uh(Ln(s),n.scrollTrigger),s}var e=t.prototype;return e.to=function(i,s,a){return Ir(0,arguments,this),this},e.from=function(i,s,a){return Ir(1,arguments,this),this},e.fromTo=function(i,s,a,o){return Ir(2,arguments,this),this},e.set=function(i,s,a){return s.duration=0,s.parent=this,Dr(s).repeatDelay||(s.repeat=0),s.immediateRender=!!s.immediateRender,new fe(i,s,tn(this,a),1),this},e.call=function(i,s,a){return vn(this,fe.delayedCall(0,i,s),a)},e.staggerTo=function(i,s,a,o,l,c,u){return a.duration=s,a.stagger=a.stagger||o,a.onComplete=c,a.onCompleteParams=u,a.parent=this,new fe(i,a,tn(this,l)),this},e.staggerFrom=function(i,s,a,o,l,c,u){return a.runBackwards=1,Dr(a).immediateRender=Ne(a.immediateRender),this.staggerTo(i,s,a,o,l,c,u)},e.staggerFromTo=function(i,s,a,o,l,c,u,d){return o.startAt=a,Dr(o).immediateRender=Ne(o.immediateRender),this.staggerTo(i,s,o,l,c,u,d)},e.render=function(i,s,a){var o=this._time,l=this._dirty?this.totalDuration():this._tDur,c=this._dur,u=i<=0?0:ne(i),d=this._zTime<0!=i<0&&(this._initted||!c),h,m,g,_,f,p,y,v,T,w,A,b;if(this!==ie&&u>l&&i>=0&&(u=l),u!==this._tTime||a||d){if(o!==this._time&&c&&(u+=this._time-o,i+=this._time-o),h=u,T=this._start,v=this._ts,p=!v,d&&(c||(o=this._zTime),(i||!s)&&(this._zTime=i)),this._repeat){if(A=this._yoyo,f=c+this._rDelay,this._repeat<-1&&i<0)return this.totalTime(f*100+i,s,a);if(h=ne(u%f),u===l?(_=this._repeat,h=c):(w=ne(u/f),_=~~w,_&&_===w&&(h=c,_--),h>c&&(h=c)),w=gr(this._tTime,f),!o&&this._tTime&&w!==_&&this._tTime-w*f-this._dur<=0&&(w=_),A&&_&1&&(h=c-h,b=1),_!==w&&!this._lock){var C=A&&w&1,M=C===(A&&_&1);if(_<w&&(C=!C),o=C?0:u%c?c:u,this._lock=1,this.render(o||(b?0:ne(_*f)),s,!c)._lock=0,this._tTime=u,!s&&this.parent&&qe(this,"onRepeat"),this.vars.repeatRefresh&&!b&&(this.invalidate()._lock=1,w=_),o&&o!==this._time||p!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(c=this._dur,l=this._tDur,M&&(this._lock=2,o=C?c:-1e-4,this.render(o,!0),this.vars.repeatRefresh&&!b&&this.invalidate()),this._lock=0,!this._ts&&!p)return this}}if(this._hasPause&&!this._forcing&&this._lock<2&&(y=Xv(this,ne(o),ne(h)),y&&(u-=h-(h=y._start))),this._tTime=u,this._time=h,this._act=!!v,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=i,o=0),!o&&u&&c&&!s&&!w&&(qe(this,"onStart"),this._tTime!==u))return this;if(h>=o&&i>=0)for(m=this._first;m;){if(g=m._next,(m._act||h>=m._start)&&m._ts&&y!==m){if(m.parent!==this)return this.render(i,s,a);if(m.render(m._ts>0?(h-m._start)*m._ts:(m._dirty?m.totalDuration():m._tDur)+(h-m._start)*m._ts,s,a),h!==this._time||!this._ts&&!p){y=0,g&&(u+=this._zTime=-jt);break}}m=g}else{m=this._last;for(var x=i<0?i:h;m;){if(g=m._prev,(m._act||x<=m._end)&&m._ts&&y!==m){if(m.parent!==this)return this.render(i,s,a);if(m.render(m._ts>0?(x-m._start)*m._ts:(m._dirty?m.totalDuration():m._tDur)+(x-m._start)*m._ts,s,a||ye&&Sl(m)),h!==this._time||!this._ts&&!p){y=0,g&&(u+=this._zTime=x?-jt:jt);break}}m=g}}if(y&&!s&&(this.pause(),y.render(h>=o?0:-jt)._zTime=h>=o?1:-1,this._ts))return this._start=T,oa(this),this.render(i,s,a);this._onUpdate&&!s&&qe(this,"onUpdate",!0),(u===l&&this._tTime>=this.totalDuration()||!u&&o)&&(T===this._start||Math.abs(v)!==Math.abs(this._ts))&&(this._lock||((i||!c)&&(u===l&&this._ts>0||!u&&this._ts<0)&&si(this,1),!s&&!(i<0&&!o)&&(u||o||!l)&&(qe(this,u===l&&i>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(u<l&&this.timeScale()>0)&&this._prom())))}return this},e.add=function(i,s){var a=this;if(zn(s)||(s=tn(this,s,i)),!(i instanceof Vr)){if(Ae(i))return i.forEach(function(o){return a.add(o,s)}),this;if(xe(i))return this.addLabel(i,s);if(le(i))i=fe.delayedCall(0,i);else return this}return this!==i?vn(this,i,s):this},e.getChildren=function(i,s,a,o){i===void 0&&(i=!0),s===void 0&&(s=!0),a===void 0&&(a=!0),o===void 0&&(o=-rn);for(var l=[],c=this._first;c;)c._start>=o&&(c instanceof fe?s&&l.push(c):(a&&l.push(c),i&&l.push.apply(l,c.getChildren(!0,s,a)))),c=c._next;return l},e.getById=function(i){for(var s=this.getChildren(1,1,1),a=s.length;a--;)if(s[a].vars.id===i)return s[a]},e.remove=function(i){return xe(i)?this.removeLabel(i):le(i)?this.killTweensOf(i):(i.parent===this&&aa(this,i),i===this._recent&&(this._recent=this._last),Li(this))},e.totalTime=function(i,s){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=ne(Xe.time-(this._ts>0?i/this._ts:(this.totalDuration()-i)/-this._ts))),r.prototype.totalTime.call(this,i,s),this._forcing=0,this):this._tTime},e.addLabel=function(i,s){return this.labels[i]=tn(this,s),this},e.removeLabel=function(i){return delete this.labels[i],this},e.addPause=function(i,s,a){var o=fe.delayedCall(0,s||zr,a);return o.data="isPause",this._hasPause=1,vn(this,o,tn(this,i))},e.removePause=function(i){var s=this._first;for(i=tn(this,i);s;)s._start===i&&s.data==="isPause"&&si(s),s=s._next},e.killTweensOf=function(i,s,a){for(var o=this.getTweensOf(i,a),l=o.length;l--;)jn!==o[l]&&o[l].kill(i,s);return this},e.getTweensOf=function(i,s){for(var a=[],o=sn(i),l=this._first,c=zn(s),u;l;)l instanceof fe?Bv(l._targets,o)&&(c?(!jn||l._initted&&l._ts)&&l.globalTime(0)<=s&&l.globalTime(l.totalDuration())>s:!s||l.isActive())&&a.push(l):(u=l.getTweensOf(o,s)).length&&a.push.apply(a,u),l=l._next;return a},e.tweenTo=function(i,s){s=s||{};var a=this,o=tn(a,i),l=s,c=l.startAt,u=l.onStart,d=l.onStartParams,h=l.immediateRender,m,g=fe.to(a,Ze({ease:s.ease||"none",lazy:!1,immediateRender:!1,time:o,overwrite:"auto",duration:s.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale())||jt,onStart:function(){if(a.pause(),!m){var f=s.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale());g._dur!==f&&vr(g,f,0,1).render(g._time,!0,!0),m=1}u&&u.apply(g,d||[])}},s));return h?g.render(0):g},e.tweenFromTo=function(i,s,a){return this.tweenTo(s,Ze({startAt:{time:tn(this,i)}},a))},e.recent=function(){return this._recent},e.nextLabel=function(i){return i===void 0&&(i=this._time),Gc(this,tn(this,i))},e.previousLabel=function(i){return i===void 0&&(i=this._time),Gc(this,tn(this,i),1)},e.currentLabel=function(i){return arguments.length?this.seek(i,!0):this.previousLabel(this._time+jt)},e.shiftChildren=function(i,s,a){a===void 0&&(a=0);var o=this._first,l=this.labels,c;for(i=ne(i);o;)o._start>=a&&(o._start+=i,o._end+=i),o=o._next;if(s)for(c in l)l[c]>=a&&(l[c]+=i);return Li(this)},e.invalidate=function(i){var s=this._first;for(this._lock=0;s;)s.invalidate(i),s=s._next;return r.prototype.invalidate.call(this,i)},e.clear=function(i){i===void 0&&(i=!0);for(var s=this._first,a;s;)a=s._next,this.remove(s),s=a;return this._dp&&(this._time=this._tTime=this._pTime=0),i&&(this.labels={}),Li(this)},e.totalDuration=function(i){var s=0,a=this,o=a._last,l=rn,c,u,d;if(arguments.length)return a.timeScale((a._repeat<0?a.duration():a.totalDuration())/(a.reversed()?-i:i));if(a._dirty){for(d=a.parent;o;)c=o._prev,o._dirty&&o.totalDuration(),u=o._start,u>l&&a._sort&&o._ts&&!a._lock?(a._lock=1,vn(a,o,u-o._delay,1)._lock=0):l=u,u<0&&o._ts&&(s-=u,(!d&&!a._dp||d&&d.smoothChildTiming)&&(a._start+=ne(u/a._ts),a._time-=u,a._tTime-=u),a.shiftChildren(-u,!1,-1/0),l=0),o._end>s&&o._ts&&(s=o._end),o=c;vr(a,a===ie&&a._time>s?a._time:s,1,1),a._dirty=0}return a._tDur},t.updateRoot=function(i){if(ie._ts&&(sh(ie,$s(i,ie)),ih=Xe.frame),Xe.frame>=zc){zc+=Ke.autoSleep||120;var s=ie._first;if((!s||!s._ts)&&Ke.autoSleep&&Xe._listeners.length<2){for(;s&&!s._ts;)s=s._next;s||Xe.sleep()}}},t}(Vr);Ze(Le.prototype,{_lock:0,_hasPause:0,_forcing:0});var l0=function(t,e,n,i,s,a,o){var l=new Fe(this._pt,t,e,0,1,Lh,null,s),c=0,u=0,d,h,m,g,_,f,p,y;for(l.b=n,l.e=i,n+="",i+="",(p=~i.indexOf("random("))&&(i=kr(i)),a&&(y=[n,i],a(y,t,e),n=y[0],i=y[1]),h=n.match(Ga)||[];d=Ga.exec(i);)g=d[0],_=i.substring(c,d.index),m?m=(m+1)%5:_.substr(-5)==="rgba("&&(m=1),g!==h[u++]&&(f=parseFloat(h[u-1])||0,l._pt={_next:l._pt,p:_||u===1?_:",",s:f,c:g.charAt(1)==="="?lr(f,g)-f:parseFloat(g)-f,m:m&&m<4?Math.round:0},c=Ga.lastIndex);return l.c=c<i.length?i.substring(c,i.length):"",l.fp=o,(Qu.test(i)||p)&&(l.e=0),this._pt=l,l},yl=function(t,e,n,i,s,a,o,l,c,u){le(i)&&(i=i(s||0,t,a));var d=t[e],h=n!=="get"?n:le(d)?c?t[e.indexOf("set")||!le(t["get"+e.substr(3)])?e:"get"+e.substr(3)](c):t[e]():d,m=le(d)?c?f0:Rh:Tl,g;if(xe(i)&&(~i.indexOf("random(")&&(i=kr(i)),i.charAt(1)==="="&&(g=lr(h,i)+(be(h)||0),(g||g===0)&&(i=g))),!u||h!==i||Xo)return!isNaN(h*i)&&i!==""?(g=new Fe(this._pt,t,e,+h||0,i-(h||0),typeof d=="boolean"?m0:Ph,0,m),c&&(g.fp=c),o&&g.modifier(o,this,t),this._pt=g):(!d&&!(e in t)&&gl(e,i),l0.call(this,t,e,h,i,m,l||Ke.stringFilter,c))},c0=function(t,e,n,i,s){if(le(t)&&(t=Ur(t,s,e,n,i)),!En(t)||t.style&&t.nodeType||Ae(t)||Zu(t))return xe(t)?Ur(t,s,e,n,i):t;var a={},o;for(o in t)a[o]=Ur(t[o],s,e,n,i);return a},Ah=function(t,e,n,i,s,a){var o,l,c,u;if(We[t]&&(o=new We[t]).init(s,o.rawVars?e[t]:c0(e[t],i,s,a,n),n,i,a)!==!1&&(n._pt=l=new Fe(n._pt,s,t,0,1,o.render,o,0,o.priority),n!==rr))for(c=n._ptLookup[n._targets.indexOf(s)],u=o._props.length;u--;)c[o._props[u]]=l;return o},jn,Xo,El=function r(t,e,n){var i=t.vars,s=i.ease,a=i.startAt,o=i.immediateRender,l=i.lazy,c=i.onUpdate,u=i.runBackwards,d=i.yoyoEase,h=i.keyframes,m=i.autoRevert,g=t._dur,_=t._startAt,f=t._targets,p=t.parent,y=p&&p.data==="nested"?p.vars.targets:f,v=t._overwrite==="auto"&&!fl,T=t.timeline,w=i.easeReverse||d,A,b,C,M,x,P,k,N,X,V,G,q,H;if(T&&(!h||!s)&&(s="none"),t._ease=Di(s,Fr.ease),t._rEase=w&&(Di(w)||t._ease),t._from=!T&&!!i.runBackwards,t._from&&(t.ratio=1),!T||h&&!i.stagger){if(N=f[0]?Pi(f[0]).harness:0,q=N&&i[N.prop],A=Ys(i,vl),_&&(_._zTime<0&&_.progress(1),e<0&&u&&o&&!m?_.render(-1,!0):_.revert(u&&g?Ns:Ov),_._lazy=0),a){if(si(t._startAt=fe.set(f,Ze({data:"isStart",overwrite:!1,parent:p,immediateRender:!0,lazy:!_&&Ne(l),startAt:null,delay:0,onUpdate:c&&function(){return qe(t,"onUpdate")},stagger:0},a))),t._startAt._dp=0,t._startAt._sat=t,e<0&&(ye||!o&&!m)&&t._startAt.revert(Ns),o&&g&&e<=0&&n<=0){e&&(t._zTime=e);return}}else if(u&&g&&!_){if(e&&(o=!1),C=Ze({overwrite:!1,data:"isFromStart",lazy:o&&!_&&Ne(l),immediateRender:o,stagger:0,parent:p},A),q&&(C[N.prop]=q),si(t._startAt=fe.set(f,C)),t._startAt._dp=0,t._startAt._sat=t,e<0&&(ye?t._startAt.revert(Ns):t._startAt.render(-1,!0)),t._zTime=e,!o)r(t._startAt,jt,jt);else if(!e)return}for(t._pt=t._ptCache=0,l=g&&Ne(l)||l&&!g,b=0;b<f.length;b++){if(x=f[b],k=x._gsap||Ml(f)[b]._gsap,t._ptLookup[b]=V={},zo[k.id]&&ei.length&&qs(),G=y===f?b:y.indexOf(x),N&&(X=new N).init(x,q||A,t,G,y)!==!1&&(t._pt=M=new Fe(t._pt,x,X.name,0,1,X.render,X,0,X.priority),X._props.forEach(function(rt){V[rt]=M}),X.priority&&(P=1)),!N||q)for(C in A)We[C]&&(X=Ah(C,A,t,G,x,y))?X.priority&&(P=1):V[C]=M=yl.call(t,x,C,"get",A[C],G,y,0,i.stringFilter);t._op&&t._op[b]&&t.kill(x,t._op[b]),v&&t._pt&&(jn=t,ie.killTweensOf(x,V,t.globalTime(e)),H=!t.parent,jn=0),t._pt&&l&&(zo[k.id]=1)}P&&Dh(t),t._onInit&&t._onInit(t)}t._onUpdate=c,t._initted=(!t._op||t._pt)&&!H,h&&e<=0&&T.render(rn,!0,!0)},u0=function(t,e,n,i,s,a,o,l){var c=(t._pt&&t._ptCache||(t._ptCache={}))[e],u,d,h,m;if(!c)for(c=t._ptCache[e]=[],h=t._ptLookup,m=t._targets.length;m--;){if(u=h[m][e],u&&u.d&&u.d._pt)for(u=u.d._pt;u&&u.p!==e&&u.fp!==e;)u=u._next;if(!u)return Xo=1,t.vars[e]="+=0",El(t,o),Xo=0,l?Br(e+" not eligible for reset. Try splitting into individual properties"):1;c.push(u)}for(m=c.length;m--;)d=c[m],u=d._pt||d,u.s=(i||i===0)&&!s?i:u.s+(i||0)+a*u.c,u.c=n-u.s,d.e&&(d.e=ce(n)+be(d.e)),d.b&&(d.b=u.s+be(d.b))},h0=function(t,e){var n=t[0]?Pi(t[0]).harness:0,i=n&&n.aliases,s,a,o,l;if(!i)return e;s=_r({},e);for(a in i)if(a in s)for(l=i[a].split(","),o=l.length;o--;)s[l[o]]=s[a];return s},d0=function(t,e,n,i){var s=e.ease||i||"power1.inOut",a,o;if(Ae(e))o=n[t]||(n[t]=[]),e.forEach(function(l,c){return o.push({t:c/(e.length-1)*100,v:l,e:s})});else for(a in e)o=n[a]||(n[a]=[]),a==="ease"||o.push({t:parseFloat(t),v:e[a],e:s})},Ur=function(t,e,n,i,s){return le(t)?t.call(e,n,i,s):xe(t)&&~t.indexOf("random(")?kr(t):t},wh=xl+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,easeReverse,autoRevert",Ch={};Oe(wh+",id,stagger,delay,duration,paused,scrollTrigger",function(r){return Ch[r]=1});var fe=function(r){Ku(t,r);function t(n,i,s,a){var o;typeof i=="number"&&(s.duration=i,i=s,s=null),o=r.call(this,a?i:Dr(i))||this;var l=o.vars,c=l.duration,u=l.delay,d=l.immediateRender,h=l.stagger,m=l.overwrite,g=l.keyframes,_=l.defaults,f=l.scrollTrigger,p=i.parent||ie,y=(Ae(n)||Zu(n)?zn(n[0]):"length"in i)?[n]:sn(n),v,T,w,A,b,C,M,x;if(o._targets=y.length?Ml(y):Br("GSAP target "+n+" not found. https://gsap.com",!Ke.nullTargetWarn)||[],o._ptLookup=[],o._overwrite=m,g||h||Cs(c)||Cs(u)){i=o.vars;var P=i.easeReverse||i.yoyoEase;if(v=o.timeline=new Le({data:"nested",defaults:_||{},targets:p&&p.data==="nested"?p.vars.targets:y}),v.kill(),v.parent=v._dp=Ln(o),v._start=0,h||Cs(c)||Cs(u)){if(A=y.length,M=h&&ph(h),En(h))for(b in h)~wh.indexOf(b)&&(x||(x={}),x[b]=h[b]);for(T=0;T<A;T++)w=Ys(i,Ch),w.stagger=0,P&&(w.easeReverse=P),x&&_r(w,x),C=y[T],w.duration=+Ur(c,Ln(o),T,C,y),w.delay=(+Ur(u,Ln(o),T,C,y)||0)-o._delay,!h&&A===1&&w.delay&&(o._delay=u=w.delay,o._start+=u,w.delay=0),v.to(C,w,M?M(T,C,y):0),v._ease=Ot.none;v.duration()?c=u=0:o.timeline=0}else if(g){Dr(Ze(v.vars.defaults,{ease:"none"})),v._ease=Di(g.ease||i.ease||"none");var k=0,N,X,V;if(Ae(g))g.forEach(function(G){return v.to(y,G,">")}),v.duration();else{w={};for(b in g)b==="ease"||b==="easeEach"||d0(b,g[b],w,g.easeEach);for(b in w)for(N=w[b].sort(function(G,q){return G.t-q.t}),k=0,T=0;T<N.length;T++)X=N[T],V={ease:X.e,duration:(X.t-(T?N[T-1].t:0))/100*c},V[b]=X.v,v.to(y,V,k),k+=V.duration;v.duration()<c&&v.to({},{duration:c-v.duration()})}}c||o.duration(c=v.duration())}else o.timeline=0;return m===!0&&!fl&&(jn=Ln(o),ie.killTweensOf(y),jn=0),vn(p,Ln(o),s),i.reversed&&o.reverse(),i.paused&&o.paused(!0),(d||!c&&!g&&o._start===ne(p._time)&&Ne(d)&&Vv(Ln(o))&&p.data!=="nested")&&(o._tTime=-jt,o.render(Math.max(0,-u)||0)),f&&uh(Ln(o),f),o}var e=t.prototype;return e.render=function(i,s,a){var o=this._time,l=this._tDur,c=this._dur,u=i<0,d=i>l-jt&&!u?l:i<jt?0:i,h,m,g,_,f,p,y,v;if(!c)Wv(this,i,s,a);else if(d!==this._tTime||!i||a||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==u||this._lazy){if(h=d,v=this.timeline,this._repeat){if(_=c+this._rDelay,this._repeat<-1&&u)return this.totalTime(_*100+i,s,a);if(h=ne(d%_),d===l?(g=this._repeat,h=c):(f=ne(d/_),g=~~f,g&&g===f?(h=c,g--):h>c&&(h=c)),p=this._yoyo&&g&1,p&&(h=c-h),f=gr(this._tTime,_),h===o&&!a&&this._initted&&g===f)return this._tTime=d,this;g!==f&&this.vars.repeatRefresh&&!p&&!this._lock&&h!==_&&this._initted&&(this._lock=a=1,this.render(ne(_*g),!0).invalidate()._lock=0)}if(!this._initted){if(hh(this,u?i:h,a,s,d))return this._tTime=0,this;if(o!==this._time&&!(a&&this.vars.repeatRefresh&&g!==f))return this;if(c!==this._dur)return this.render(i,s,a)}if(this._rEase){var T=h<o;if(T!==this._inv){var w=T?o:c-o;this._inv=T,this._from&&(this.ratio=1-this.ratio),this._invRatio=this.ratio,this._invTime=o,this._invRecip=w?(T?-1:1)/w:0,this._invScale=T?-this.ratio:1-this.ratio,this._invEase=T?this._rEase:this._ease}this.ratio=y=this._invRatio+this._invScale*this._invEase((h-this._invTime)*this._invRecip)}else this.ratio=y=this._ease(h/c);if(this._from&&(this.ratio=y=1-y),this._tTime=d,this._time=h,!this._act&&this._ts&&(this._act=1,this._lazy=0),!o&&d&&!s&&!f&&(qe(this,"onStart"),this._tTime!==d))return this;for(m=this._pt;m;)m.r(y,m.d),m=m._next;v&&v.render(i<0?i:v._dur*v._ease(h/this._dur),s,a)||this._startAt&&(this._zTime=i),this._onUpdate&&!s&&(u&&ko(this,i,s,a),qe(this,"onUpdate")),this._repeat&&g!==f&&this.vars.onRepeat&&!s&&this.parent&&qe(this,"onRepeat"),(d===this._tDur||!d)&&this._tTime===d&&(u&&!this._onUpdate&&ko(this,i,!0,!0),(i||!c)&&(d===this._tDur&&this._ts>0||!d&&this._ts<0)&&si(this,1),!s&&!(u&&!o)&&(d||o||p)&&(qe(this,d===l?"onComplete":"onReverseComplete",!0),this._prom&&!(d<l&&this.timeScale()>0)&&this._prom()))}return this},e.targets=function(){return this._targets},e.invalidate=function(i){return(!i||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(i),r.prototype.invalidate.call(this,i)},e.resetTo=function(i,s,a,o,l){Hr||Xe.wake(),this._ts||this.play();var c=Math.min(this._dur,(this._dp._time-this._start)*this._ts),u;return this._initted||El(this,c),u=this._ease(c/this._dur),u0(this,i,s,a,o,u,c,l)?this.resetTo(i,s,a,o,1):(la(this,0),this.parent||lh(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},e.kill=function(i,s){if(s===void 0&&(s="all"),!i&&(!s||s==="all"))return this._lazy=this._pt=0,this.parent?Pr(this):this.scrollTrigger&&this.scrollTrigger.kill(!!ye),this;if(this.timeline){var a=this.timeline.totalDuration();return this.timeline.killTweensOf(i,s,jn&&jn.vars.overwrite!==!0)._first||Pr(this),this.parent&&a!==this.timeline.totalDuration()&&vr(this,this._dur*this.timeline._tDur/a,0,1),this}var o=this._targets,l=i?sn(i):o,c=this._ptLookup,u=this._pt,d,h,m,g,_,f,p;if((!s||s==="all")&&kv(o,l))return s==="all"&&(this._pt=0),Pr(this);for(d=this._op=this._op||[],s!=="all"&&(xe(s)&&(_={},Oe(s,function(y){return _[y]=1}),s=_),s=h0(o,s)),p=o.length;p--;)if(~l.indexOf(o[p])){h=c[p],s==="all"?(d[p]=s,g=h,m={}):(m=d[p]=d[p]||{},g=s);for(_ in g)f=h&&h[_],f&&((!("kill"in f.d)||f.d.kill(_)===!0)&&aa(this,f,"_pt"),delete h[_]),m!=="all"&&(m[_]=1)}return this._initted&&!this._pt&&u&&Pr(this),this},t.to=function(i,s){return new t(i,s,arguments[2])},t.from=function(i,s){return Ir(1,arguments)},t.delayedCall=function(i,s,a,o){return new t(s,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:i,onComplete:s,onReverseComplete:s,onCompleteParams:a,onReverseCompleteParams:a,callbackScope:o})},t.fromTo=function(i,s,a){return Ir(2,arguments)},t.set=function(i,s){return s.duration=0,s.repeatDelay||(s.repeat=0),new t(i,s)},t.killTweensOf=function(i,s,a){return ie.killTweensOf(i,s,a)},t}(Vr);Ze(fe.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});Oe("staggerTo,staggerFrom,staggerFromTo",function(r){fe[r]=function(){var t=new Le,e=Vo.call(arguments,0);return e.splice(r==="staggerFromTo"?5:4,0,0),t[r].apply(t,e)}});var Tl=function(t,e,n){return t[e]=n},Rh=function(t,e,n){return t[e](n)},f0=function(t,e,n,i){return t[e](i.fp,n)},p0=function(t,e,n){return t.setAttribute(e,n)},bl=function(t,e){return le(t[e])?Rh:pl(t[e])&&t.setAttribute?p0:Tl},Ph=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e6)/1e6,e)},m0=function(t,e){return e.set(e.t,e.p,!!(e.s+e.c*t),e)},Lh=function(t,e){var n=e._pt,i="";if(!t&&e.b)i=e.b;else if(t===1&&e.e)i=e.e;else{for(;n;)i=n.p+(n.m?n.m(n.s+n.c*t):Math.round((n.s+n.c*t)*1e4)/1e4)+i,n=n._next;i+=e.c}e.set(e.t,e.p,i,e)},Al=function(t,e){for(var n=e._pt;n;)n.r(t,n.d),n=n._next},_0=function(t,e,n,i){for(var s=this._pt,a;s;)a=s._next,s.p===i&&s.modifier(t,e,n),s=a},g0=function(t){for(var e=this._pt,n,i;e;)i=e._next,e.p===t&&!e.op||e.op===t?aa(this,e,"_pt"):e.dep||(n=1),e=i;return!n},v0=function(t,e,n,i){i.mSet(t,e,i.m.call(i.tween,n,i.mt),i)},Dh=function(t){for(var e=t._pt,n,i,s,a;e;){for(n=e._next,i=s;i&&i.pr>e.pr;)i=i._next;(e._prev=i?i._prev:a)?e._prev._next=e:s=e,(e._next=i)?i._prev=e:a=e,e=n}t._pt=s},Fe=function(){function r(e,n,i,s,a,o,l,c,u){this.t=n,this.s=s,this.c=a,this.p=i,this.r=o||Ph,this.d=l||this,this.set=c||Tl,this.pr=u||0,this._next=e,e&&(e._prev=this)}var t=r.prototype;return t.modifier=function(n,i,s){this.mSet=this.mSet||this.set,this.set=v0,this.m=n,this.mt=s,this.tween=i},r}();Oe(xl+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger,easeReverse",function(r){return vl[r]=1});je.TweenMax=je.TweenLite=fe;je.TimelineLite=je.TimelineMax=Le;ie=new Le({sortChildren:!1,defaults:Fr,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});Ke.stringFilter=Eh;var Ii=[],Fs={},x0=[],Xc=0,M0=0,$a=function(t){return(Fs[t]||x0).map(function(e){return e()})},qo=function(){var t=Date.now(),e=[];t-Xc>2&&($a("matchMediaInit"),Ii.forEach(function(n){var i=n.queries,s=n.conditions,a,o,l,c;for(o in i)a=pn.matchMedia(i[o]).matches,a&&(l=1),a!==s[o]&&(s[o]=a,c=1);c&&(n.revert(),l&&e.push(n))}),$a("matchMediaRevert"),e.forEach(function(n){return n.onMatch(n,function(i){return n.add(null,i)})}),Xc=t,$a("matchMedia"))},Ih=function(){function r(e,n){this.selector=n&&Go(n),this.data=[],this._r=[],this.isReverted=!1,this.id=M0++,e&&this.add(e)}var t=r.prototype;return t.add=function(n,i,s){le(n)&&(s=i,i=n,n=le);var a=this,o=function(){var c=te,u=a.selector,d;return c&&c!==a&&c.data.push(a),s&&(a.selector=Go(s)),te=a,d=i.apply(a,arguments),le(d)&&a._r.push(d),te=c,a.selector=u,a.isReverted=!1,d};return a.last=o,n===le?o(a,function(l){return a.add(null,l)}):n?a[n]=o:o},t.ignore=function(n){var i=te;te=null,n(this),te=i},t.getTweens=function(){var n=[];return this.data.forEach(function(i){return i instanceof r?n.push.apply(n,i.getTweens()):i instanceof fe&&!(i.parent&&i.parent.data==="nested")&&n.push(i)}),n},t.clear=function(){this._r.length=this.data.length=0},t.kill=function(n,i){var s=this;if(n?function(){for(var o=s.getTweens(),l=s.data.length,c;l--;)c=s.data[l],c.data==="isFlip"&&(c.revert(),c.getChildren(!0,!0,!1).forEach(function(u){return o.splice(o.indexOf(u),1)}));for(o.map(function(u){return{g:u._dur||u._delay||u._sat&&!u._sat.vars.immediateRender?u.globalTime(0):-1/0,t:u}}).sort(function(u,d){return d.g-u.g||-1/0}).forEach(function(u){return u.t.revert(n)}),l=s.data.length;l--;)c=s.data[l],c instanceof Le?c.data!=="nested"&&(c.scrollTrigger&&c.scrollTrigger.revert(),c.kill()):!(c instanceof fe)&&c.revert&&c.revert(n);s._r.forEach(function(u){return u(n,s)}),s.isReverted=!0}():this.data.forEach(function(o){return o.kill&&o.kill()}),this.clear(),i)for(var a=Ii.length;a--;)Ii[a].id===this.id&&Ii.splice(a,1)},t.revert=function(n){this.kill(n||{})},r}(),S0=function(){function r(e){this.contexts=[],this.scope=e,te&&te.data.push(this)}var t=r.prototype;return t.add=function(n,i,s){En(n)||(n={matches:n});var a=new Ih(0,s||this.scope),o=a.conditions={},l,c,u;te&&!a.selector&&(a.selector=te.selector),this.contexts.push(a),i=a.add("onMatch",i),a.queries=n;for(c in n)c==="all"?u=1:(l=pn.matchMedia(n[c]),l&&(Ii.indexOf(a)<0&&Ii.push(a),(o[c]=l.matches)&&(u=1),l.addListener?l.addListener(qo):l.addEventListener("change",qo)));return u&&i(a,function(d){return a.add(null,d)}),this},t.revert=function(n){this.kill(n||{})},t.kill=function(n){this.contexts.forEach(function(i){return i.kill(n,!0)})},r}(),Ks={registerPlugin:function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];e.forEach(function(i){return Mh(i)})},timeline:function(t){return new Le(t)},getTweensOf:function(t,e){return ie.getTweensOf(t,e)},getProperty:function(t,e,n,i){xe(t)&&(t=sn(t)[0]);var s=Pi(t||{}).get,a=n?oh:ah;return n==="native"&&(n=""),t&&(e?a((We[e]&&We[e].get||s)(t,e,n,i)):function(o,l,c){return a((We[o]&&We[o].get||s)(t,o,l,c))})},quickSetter:function(t,e,n){if(t=sn(t),t.length>1){var i=t.map(function(u){return ze.quickSetter(u,e,n)}),s=i.length;return function(u){for(var d=s;d--;)i[d](u)}}t=t[0]||{};var a=We[e],o=Pi(t),l=o.harness&&(o.harness.aliases||{})[e]||e,c=a?function(u){var d=new a;rr._pt=0,d.init(t,n?u+n:u,rr,0,[t]),d.render(1,d),rr._pt&&Al(1,rr)}:o.set(t,l);return a?c:function(u){return c(t,l,n?u+n:u,o,1)}},quickTo:function(t,e,n){var i,s=ze.to(t,Ze((i={},i[e]="+=0.1",i.paused=!0,i.stagger=0,i),n||{})),a=function(l,c,u){return s.resetTo(e,l,c,u)};return a.tween=s,a},isTweening:function(t){return ie.getTweensOf(t,!0).length>0},defaults:function(t){return t&&t.ease&&(t.ease=Di(t.ease,Fr.ease)),kc(Fr,t||{})},config:function(t){return kc(Ke,t||{})},registerEffect:function(t){var e=t.name,n=t.effect,i=t.plugins,s=t.defaults,a=t.extendTimeline;(i||"").split(",").forEach(function(o){return o&&!We[o]&&!je[o]&&Br(e+" effect requires "+o+" plugin.")}),Wa[e]=function(o,l,c){return n(sn(o),Ze(l||{},s),c)},a&&(Le.prototype[e]=function(o,l,c){return this.add(Wa[e](o,En(l)?l:(c=l)&&{},this),c)})},registerEase:function(t,e){Ot[t]=Di(e)},parseEase:function(t,e){return arguments.length?Di(t,e):Ot},getById:function(t){return ie.getById(t)},exportRoot:function(t,e){t===void 0&&(t={});var n=new Le(t),i,s;for(n.smoothChildTiming=Ne(t.smoothChildTiming),ie.remove(n),n._dp=0,n._time=n._tTime=ie._time,i=ie._first;i;)s=i._next,(e||!(!i._dur&&i instanceof fe&&i.vars.onComplete===i._targets[0]))&&vn(n,i,i._start-i._delay),i=s;return vn(ie,n,0),n},context:function(t,e){return t?new Ih(t,e):te},matchMedia:function(t){return new S0(t)},matchMediaRefresh:function(){return Ii.forEach(function(t){var e=t.conditions,n,i;for(i in e)e[i]&&(e[i]=!1,n=1);n&&t.revert()})||qo()},addEventListener:function(t,e){var n=Fs[t]||(Fs[t]=[]);~n.indexOf(e)||n.push(e)},removeEventListener:function(t,e){var n=Fs[t],i=n&&n.indexOf(e);i>=0&&n.splice(i,1)},utils:{wrap:Jv,wrapYoyo:Qv,distribute:ph,random:_h,snap:mh,normalize:Zv,getUnit:be,clamp:Yv,splitColor:Sh,toArray:sn,selector:Go,mapRange:vh,pipe:Kv,unitize:jv,interpolate:t0,shuffle:fh},install:eh,effects:Wa,ticker:Xe,updateRoot:Le.updateRoot,plugins:We,globalTimeline:ie,core:{PropTween:Fe,globals:nh,Tween:fe,Timeline:Le,Animation:Vr,getCache:Pi,_removeLinkedListItem:aa,reverting:function(){return ye},context:function(t){return t&&te&&(te.data.push(t),t._ctx=te),te},suppressOverwrites:function(t){return fl=t}}};Oe("to,from,fromTo,delayedCall,set,killTweensOf",function(r){return Ks[r]=fe[r]});Xe.add(Le.updateRoot);rr=Ks.to({},{duration:0});var y0=function(t,e){for(var n=t._pt;n&&n.p!==e&&n.op!==e&&n.fp!==e;)n=n._next;return n},E0=function(t,e){var n=t._targets,i,s,a;for(i in e)for(s=n.length;s--;)a=t._ptLookup[s][i],a&&(a=a.d)&&(a._pt&&(a=y0(a,i)),a&&a.modifier&&a.modifier(e[i],t,n[s],i))},Ka=function(t,e){return{name:t,headless:1,rawVars:1,init:function(i,s,a){a._onInit=function(o){var l,c;if(xe(s)&&(l={},Oe(s,function(u){return l[u]=1}),s=l),e){l={};for(c in s)l[c]=e(s[c]);s=l}E0(o,s)}}}},ze=Ks.registerPlugin({name:"attr",init:function(t,e,n,i,s){var a,o,l;this.tween=n;for(a in e)l=t.getAttribute(a)||"",o=this.add(t,"setAttribute",(l||0)+"",e[a],i,s,0,0,a),o.op=a,o.b=l,this._props.push(a)},render:function(t,e){for(var n=e._pt;n;)ye?n.set(n.t,n.p,n.b,n):n.r(t,n.d),n=n._next}},{name:"endArray",headless:1,init:function(t,e){for(var n=e.length;n--;)this.add(t,n,t[n]||0,e[n],0,0,0,0,0,1)}},Ka("roundProps",Wo),Ka("modifiers"),Ka("snap",mh))||Ks;fe.version=Le.version=ze.version="3.15.0";th=1;ml()&&xr();Ot.Power0;Ot.Power1;Ot.Power2;Ot.Power3;Ot.Power4;Ot.Linear;Ot.Quad;Ot.Cubic;Ot.Quart;Ot.Quint;Ot.Strong;Ot.Elastic;Ot.Back;Ot.SteppedEase;Ot.Bounce;Ot.Sine;Ot.Expo;Ot.Circ;/*!
 * CSSPlugin 3.15.0
 * https://gsap.com
 *
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var qc,Zn,cr,wl,Ci,Yc,Cl,T0=function(){return typeof window<"u"},kn={},yi=180/Math.PI,ur=Math.PI/180,er=Math.atan2,$c=1e8,Rl=/([A-Z])/g,b0=/(left|right|width|margin|padding|x)/i,A0=/[\s,\(]\S/,Mn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Yo=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},w0=function(t,e){return e.set(e.t,e.p,t===1?e.e:Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},C0=function(t,e){return e.set(e.t,e.p,t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},R0=function(t,e){return e.set(e.t,e.p,t===1?e.e:t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},P0=function(t,e){var n=e.s+e.c*t;e.set(e.t,e.p,~~(n+(n<0?-.5:.5))+e.u,e)},Uh=function(t,e){return e.set(e.t,e.p,t?e.e:e.b,e)},Nh=function(t,e){return e.set(e.t,e.p,t!==1?e.b:e.e,e)},L0=function(t,e,n){return t.style[e]=n},D0=function(t,e,n){return t.style.setProperty(e,n)},I0=function(t,e,n){return t._gsap[e]=n},U0=function(t,e,n){return t._gsap.scaleX=t._gsap.scaleY=n},N0=function(t,e,n,i,s){var a=t._gsap;a.scaleX=a.scaleY=n,a.renderTransform(s,a)},O0=function(t,e,n,i,s){var a=t._gsap;a[e]=n,a.renderTransform(s,a)},re="transform",Be=re+"Origin",F0=function r(t,e){var n=this,i=this.target,s=i.style,a=i._gsap;if(t in kn&&s){if(this.tfm=this.tfm||{},t!=="transform")t=Mn[t]||t,~t.indexOf(",")?t.split(",").forEach(function(o){return n.tfm[o]=Dn(i,o)}):this.tfm[t]=a.x?a[t]:Dn(i,t),t===Be&&(this.tfm.zOrigin=a.zOrigin);else return Mn.transform.split(",").forEach(function(o){return r.call(n,o,e)});if(this.props.indexOf(re)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(Be,e,"")),t=re}(s||e)&&this.props.push(t,e,s[t])},Oh=function(t){t.translate&&(t.removeProperty("translate"),t.removeProperty("scale"),t.removeProperty("rotate"))},B0=function(){var t=this.props,e=this.target,n=e.style,i=e._gsap,s,a;for(s=0;s<t.length;s+=3)t[s+1]?t[s+1]===2?e[t[s]](t[s+2]):e[t[s]]=t[s+2]:t[s+2]?n[t[s]]=t[s+2]:n.removeProperty(t[s].substr(0,2)==="--"?t[s]:t[s].replace(Rl,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),e.setAttribute("data-svg-origin",this.svgo||"")),s=Cl(),(!s||!s.isStart)&&!n[re]&&(Oh(n),i.zOrigin&&n[Be]&&(n[Be]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},Fh=function(t,e){var n={target:t,props:[],revert:B0,save:F0};return t._gsap||ze.core.getCache(t),e&&t.style&&t.nodeType&&e.split(",").forEach(function(i){return n.save(i)}),n},Bh,$o=function(t,e){var n=Zn.createElementNS?Zn.createElementNS((e||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),t):Zn.createElement(t);return n&&n.style?n:Zn.createElement(t)},Ye=function r(t,e,n){var i=getComputedStyle(t);return i[e]||i.getPropertyValue(e.replace(Rl,"-$1").toLowerCase())||i.getPropertyValue(e)||!n&&r(t,Mr(e)||e,1)||""},Kc="O,Moz,ms,Ms,Webkit".split(","),Mr=function(t,e,n){var i=e||Ci,s=i.style,a=5;if(t in s&&!n)return t;for(t=t.charAt(0).toUpperCase()+t.substr(1);a--&&!(Kc[a]+t in s););return a<0?null:(a===3?"ms":a>=0?Kc[a]:"")+t},Ko=function(){T0()&&window.document&&(qc=window,Zn=qc.document,cr=Zn.documentElement,Ci=$o("div")||{style:{}},$o("div"),re=Mr(re),Be=re+"Origin",Ci.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",Bh=!!Mr("perspective"),Cl=ze.core.reverting,wl=1)},jc=function(t){var e=t.ownerSVGElement,n=$o("svg",e&&e.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),i=t.cloneNode(!0),s;i.style.display="block",n.appendChild(i),cr.appendChild(n);try{s=i.getBBox()}catch{}return n.removeChild(i),cr.removeChild(n),s},Zc=function(t,e){for(var n=e.length;n--;)if(t.hasAttribute(e[n]))return t.getAttribute(e[n])},zh=function(t){var e,n;try{e=t.getBBox()}catch{e=jc(t),n=1}return e&&(e.width||e.height)||n||(e=jc(t)),e&&!e.width&&!e.x&&!e.y?{x:+Zc(t,["x","cx","x1"])||0,y:+Zc(t,["y","cy","y1"])||0,width:0,height:0}:e},kh=function(t){return!!(t.getCTM&&(!t.parentNode||t.ownerSVGElement)&&zh(t))},ai=function(t,e){if(e){var n=t.style,i;e in kn&&e!==Be&&(e=re),n.removeProperty?(i=e.substr(0,2),(i==="ms"||e.substr(0,6)==="webkit")&&(e="-"+e),n.removeProperty(i==="--"?e:e.replace(Rl,"-$1").toLowerCase())):n.removeAttribute(e)}},Jn=function(t,e,n,i,s,a){var o=new Fe(t._pt,e,n,0,1,a?Nh:Uh);return t._pt=o,o.b=i,o.e=s,t._props.push(n),o},Jc={deg:1,rad:1,turn:1},z0={grid:1,flex:1},oi=function r(t,e,n,i){var s=parseFloat(n)||0,a=(n+"").trim().substr((s+"").length)||"px",o=Ci.style,l=b0.test(e),c=t.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),d=100,h=i==="px",m=i==="%",g,_,f,p;if(i===a||!s||Jc[i]||Jc[a])return s;if(a!=="px"&&!h&&(s=r(t,e,n,"px")),p=t.getCTM&&kh(t),(m||a==="%")&&(kn[e]||~e.indexOf("adius")))return g=p?t.getBBox()[l?"width":"height"]:t[u],ce(m?s/g*d:s/100*g);if(o[l?"width":"height"]=d+(h?a:i),_=i!=="rem"&&~e.indexOf("adius")||i==="em"&&t.appendChild&&!c?t:t.parentNode,p&&(_=(t.ownerSVGElement||{}).parentNode),(!_||_===Zn||!_.appendChild)&&(_=Zn.body),f=_._gsap,f&&m&&f.width&&l&&f.time===Xe.time&&!f.uncache)return ce(s/f.width*d);if(m&&(e==="height"||e==="width")){var y=t.style[e];t.style[e]=d+i,g=t[u],y?t.style[e]=y:ai(t,e)}else(m||a==="%")&&!z0[Ye(_,"display")]&&(o.position=Ye(t,"position")),_===t&&(o.position="static"),_.appendChild(Ci),g=Ci[u],_.removeChild(Ci),o.position="absolute";return l&&m&&(f=Pi(_),f.time=Xe.time,f.width=_[u]),ce(h?g*s/d:g&&s?d/g*s:0)},Dn=function(t,e,n,i){var s;return wl||Ko(),e in Mn&&e!=="transform"&&(e=Mn[e],~e.indexOf(",")&&(e=e.split(",")[0])),kn[e]&&e!=="transform"?(s=Wr(t,i),s=e!=="transformOrigin"?s[e]:s.svg?s.origin:Zs(Ye(t,Be))+" "+s.zOrigin+"px"):(s=t.style[e],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=js[e]&&js[e](t,e,n)||Ye(t,e)||rh(t,e)||(e==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?oi(t,e,s,n)+n:s},k0=function(t,e,n,i){if(!n||n==="none"){var s=Mr(e,t,1),a=s&&Ye(t,s,1);a&&a!==n?(e=s,n=a):e==="borderColor"&&(n=Ye(t,"borderTopColor"))}var o=new Fe(this._pt,t.style,e,0,1,Lh),l=0,c=0,u,d,h,m,g,_,f,p,y,v,T,w;if(o.b=n,o.e=i,n+="",i+="",i.substring(0,6)==="var(--"&&(i=Ye(t,i.substring(4,i.indexOf(")")))),i==="auto"&&(_=t.style[e],t.style[e]=i,i=Ye(t,e)||i,_?t.style[e]=_:ai(t,e)),u=[n,i],Eh(u),n=u[0],i=u[1],h=n.match(ir)||[],w=i.match(ir)||[],w.length){for(;d=ir.exec(i);)f=d[0],y=i.substring(l,d.index),g?g=(g+1)%5:(y.substr(-5)==="rgba("||y.substr(-5)==="hsla(")&&(g=1),f!==(_=h[c++]||"")&&(m=parseFloat(_)||0,T=_.substr((m+"").length),f.charAt(1)==="="&&(f=lr(m,f)+T),p=parseFloat(f),v=f.substr((p+"").length),l=ir.lastIndex-v.length,v||(v=v||Ke.units[e]||T,l===i.length&&(i+=v,o.e+=v)),T!==v&&(m=oi(t,e,_,v)||0),o._pt={_next:o._pt,p:y||c===1?y:",",s:m,c:p-m,m:g&&g<4||e==="zIndex"?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=e==="display"&&i==="none"?Nh:Uh;return Qu.test(i)&&(o.e=0),this._pt=o,o},Qc={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},H0=function(t){var e=t.split(" "),n=e[0],i=e[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(t=n,n=i,i=t),e[0]=Qc[n]||n,e[1]=Qc[i]||i,e.join(" ")},V0=function(t,e){if(e.tween&&e.tween._time===e.tween._dur){var n=e.t,i=n.style,s=e.u,a=n._gsap,o,l,c;if(s==="all"||s===!0)i.cssText="",l=1;else for(s=s.split(","),c=s.length;--c>-1;)o=s[c],kn[o]&&(l=1,o=o==="transformOrigin"?Be:re),ai(n,o);l&&(ai(n,re),a&&(a.svg&&n.removeAttribute("transform"),i.scale=i.rotate=i.translate="none",Wr(n,1),a.uncache=1,Oh(i)))}},js={clearProps:function(t,e,n,i,s){if(s.data!=="isFromStart"){var a=t._pt=new Fe(t._pt,e,n,0,0,V0);return a.u=i,a.pr=-10,a.tween=s,t._props.push(n),1}}},Gr=[1,0,0,1,0,0],Hh={},Vh=function(t){return t==="matrix(1, 0, 0, 1, 0, 0)"||t==="none"||!t},tu=function(t){var e=Ye(t,re);return Vh(e)?Gr:e.substr(7).match(Ju).map(ce)},Pl=function(t,e){var n=t._gsap||Pi(t),i=t.style,s=tu(t),a,o,l,c;return n.svg&&t.getAttribute("transform")?(l=t.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?Gr:s):(s===Gr&&!t.offsetParent&&t!==cr&&!n.svg&&(l=i.display,i.display="block",a=t.parentNode,(!a||!t.offsetParent&&!t.getBoundingClientRect().width)&&(c=1,o=t.nextElementSibling,cr.appendChild(t)),s=tu(t),l?i.display=l:ai(t,"display"),c&&(o?a.insertBefore(t,o):a?a.appendChild(t):cr.removeChild(t))),e&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},jo=function(t,e,n,i,s,a){var o=t._gsap,l=s||Pl(t,!0),c=o.xOrigin||0,u=o.yOrigin||0,d=o.xOffset||0,h=o.yOffset||0,m=l[0],g=l[1],_=l[2],f=l[3],p=l[4],y=l[5],v=e.split(" "),T=parseFloat(v[0])||0,w=parseFloat(v[1])||0,A,b,C,M;n?l!==Gr&&(b=m*f-g*_)&&(C=T*(f/b)+w*(-_/b)+(_*y-f*p)/b,M=T*(-g/b)+w*(m/b)-(m*y-g*p)/b,T=C,w=M):(A=zh(t),T=A.x+(~v[0].indexOf("%")?T/100*A.width:T),w=A.y+(~(v[1]||v[0]).indexOf("%")?w/100*A.height:w)),i||i!==!1&&o.smooth?(p=T-c,y=w-u,o.xOffset=d+(p*m+y*_)-p,o.yOffset=h+(p*g+y*f)-y):o.xOffset=o.yOffset=0,o.xOrigin=T,o.yOrigin=w,o.smooth=!!i,o.origin=e,o.originIsAbsolute=!!n,t.style[Be]="0px 0px",a&&(Jn(a,o,"xOrigin",c,T),Jn(a,o,"yOrigin",u,w),Jn(a,o,"xOffset",d,o.xOffset),Jn(a,o,"yOffset",h,o.yOffset)),t.setAttribute("data-svg-origin",T+" "+w)},Wr=function(t,e){var n=t._gsap||new bh(t);if("x"in n&&!e&&!n.uncache)return n;var i=t.style,s=n.scaleX<0,a="px",o="deg",l=getComputedStyle(t),c=Ye(t,Be)||"0",u,d,h,m,g,_,f,p,y,v,T,w,A,b,C,M,x,P,k,N,X,V,G,q,H,rt,ot,lt,Ct,pt,W,j;return u=d=h=_=f=p=y=v=T=0,m=g=1,n.svg=!!(t.getCTM&&kh(t)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[re]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[re]!=="none"?l[re]:"")),i.scale=i.rotate=i.translate="none"),b=Pl(t,n.svg),n.svg&&(n.uncache?(H=t.getBBox(),c=n.xOrigin-H.x+"px "+(n.yOrigin-H.y)+"px",q=""):q=!e&&t.getAttribute("data-svg-origin"),jo(t,q||c,!!q||n.originIsAbsolute,n.smooth!==!1,b)),w=n.xOrigin||0,A=n.yOrigin||0,b!==Gr&&(P=b[0],k=b[1],N=b[2],X=b[3],u=V=b[4],d=G=b[5],b.length===6?(m=Math.sqrt(P*P+k*k),g=Math.sqrt(X*X+N*N),_=P||k?er(k,P)*yi:0,y=N||X?er(N,X)*yi+_:0,y&&(g*=Math.abs(Math.cos(y*ur))),n.svg&&(u-=w-(w*P+A*N),d-=A-(w*k+A*X))):(j=b[6],pt=b[7],ot=b[8],lt=b[9],Ct=b[10],W=b[11],u=b[12],d=b[13],h=b[14],C=er(j,Ct),f=C*yi,C&&(M=Math.cos(-C),x=Math.sin(-C),q=V*M+ot*x,H=G*M+lt*x,rt=j*M+Ct*x,ot=V*-x+ot*M,lt=G*-x+lt*M,Ct=j*-x+Ct*M,W=pt*-x+W*M,V=q,G=H,j=rt),C=er(-N,Ct),p=C*yi,C&&(M=Math.cos(-C),x=Math.sin(-C),q=P*M-ot*x,H=k*M-lt*x,rt=N*M-Ct*x,W=X*x+W*M,P=q,k=H,N=rt),C=er(k,P),_=C*yi,C&&(M=Math.cos(C),x=Math.sin(C),q=P*M+k*x,H=V*M+G*x,k=k*M-P*x,G=G*M-V*x,P=q,V=H),f&&Math.abs(f)+Math.abs(_)>359.9&&(f=_=0,p=180-p),m=ce(Math.sqrt(P*P+k*k+N*N)),g=ce(Math.sqrt(G*G+j*j)),C=er(V,G),y=Math.abs(C)>2e-4?C*yi:0,T=W?1/(W<0?-W:W):0),n.svg&&(q=t.getAttribute("transform"),n.forceCSS=t.setAttribute("transform","")||!Vh(Ye(t,re)),q&&t.setAttribute("transform",q))),Math.abs(y)>90&&Math.abs(y)<270&&(s?(m*=-1,y+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,y+=y<=0?180:-180)),e=e||n.uncache,n.x=u-((n.xPercent=u&&(!e&&n.xPercent||(Math.round(t.offsetWidth/2)===Math.round(-u)?-50:0)))?t.offsetWidth*n.xPercent/100:0)+a,n.y=d-((n.yPercent=d&&(!e&&n.yPercent||(Math.round(t.offsetHeight/2)===Math.round(-d)?-50:0)))?t.offsetHeight*n.yPercent/100:0)+a,n.z=h+a,n.scaleX=ce(m),n.scaleY=ce(g),n.rotation=ce(_)+o,n.rotationX=ce(f)+o,n.rotationY=ce(p)+o,n.skewX=y+o,n.skewY=v+o,n.transformPerspective=T+a,(n.zOrigin=parseFloat(c.split(" ")[2])||!e&&n.zOrigin||0)&&(i[Be]=Zs(c)),n.xOffset=n.yOffset=0,n.force3D=Ke.force3D,n.renderTransform=n.svg?W0:Bh?Gh:G0,n.uncache=0,n},Zs=function(t){return(t=t.split(" "))[0]+" "+t[1]},ja=function(t,e,n){var i=be(e);return ce(parseFloat(e)+parseFloat(oi(t,"x",n+"px",i)))+i},G0=function(t,e){e.z="0px",e.rotationY=e.rotationX="0deg",e.force3D=0,Gh(t,e)},gi="0deg",Cr="0px",vi=") ",Gh=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,u=n.rotationY,d=n.rotationX,h=n.skewX,m=n.skewY,g=n.scaleX,_=n.scaleY,f=n.transformPerspective,p=n.force3D,y=n.target,v=n.zOrigin,T="",w=p==="auto"&&t&&t!==1||p===!0;if(v&&(d!==gi||u!==gi)){var A=parseFloat(u)*ur,b=Math.sin(A),C=Math.cos(A),M;A=parseFloat(d)*ur,M=Math.cos(A),a=ja(y,a,b*M*-v),o=ja(y,o,-Math.sin(A)*-v),l=ja(y,l,C*M*-v+v)}f!==Cr&&(T+="perspective("+f+vi),(i||s)&&(T+="translate("+i+"%, "+s+"%) "),(w||a!==Cr||o!==Cr||l!==Cr)&&(T+=l!==Cr||w?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+vi),c!==gi&&(T+="rotate("+c+vi),u!==gi&&(T+="rotateY("+u+vi),d!==gi&&(T+="rotateX("+d+vi),(h!==gi||m!==gi)&&(T+="skew("+h+", "+m+vi),(g!==1||_!==1)&&(T+="scale("+g+", "+_+vi),y.style[re]=T||"translate(0, 0)"},W0=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,u=n.skewY,d=n.scaleX,h=n.scaleY,m=n.target,g=n.xOrigin,_=n.yOrigin,f=n.xOffset,p=n.yOffset,y=n.forceCSS,v=parseFloat(a),T=parseFloat(o),w,A,b,C,M;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=ur,c*=ur,w=Math.cos(l)*d,A=Math.sin(l)*d,b=Math.sin(l-c)*-h,C=Math.cos(l-c)*h,c&&(u*=ur,M=Math.tan(c-u),M=Math.sqrt(1+M*M),b*=M,C*=M,u&&(M=Math.tan(u),M=Math.sqrt(1+M*M),w*=M,A*=M)),w=ce(w),A=ce(A),b=ce(b),C=ce(C)):(w=d,C=h,A=b=0),(v&&!~(a+"").indexOf("px")||T&&!~(o+"").indexOf("px"))&&(v=oi(m,"x",a,"px"),T=oi(m,"y",o,"px")),(g||_||f||p)&&(v=ce(v+g-(g*w+_*b)+f),T=ce(T+_-(g*A+_*C)+p)),(i||s)&&(M=m.getBBox(),v=ce(v+i/100*M.width),T=ce(T+s/100*M.height)),M="matrix("+w+","+A+","+b+","+C+","+v+","+T+")",m.setAttribute("transform",M),y&&(m.style[re]=M)},X0=function(t,e,n,i,s){var a=360,o=xe(s),l=parseFloat(s)*(o&&~s.indexOf("rad")?yi:1),c=l-i,u=i+c+"deg",d,h;return o&&(d=s.split("_")[1],d==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-a)),d==="cw"&&c<0?c=(c+a*$c)%a-~~(c/a)*a:d==="ccw"&&c>0&&(c=(c-a*$c)%a-~~(c/a)*a)),t._pt=h=new Fe(t._pt,e,n,i,c,w0),h.e=u,h.u="deg",t._props.push(n),h},eu=function(t,e){for(var n in e)t[n]=e[n];return t},q0=function(t,e,n){var i=eu({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,u,d,h,m,g;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[re]=e,o=Wr(n,1),ai(n,re),n.setAttribute("transform",c)):(c=getComputedStyle(n)[re],a[re]=e,o=Wr(n,1),a[re]=c);for(l in kn)c=i[l],u=o[l],c!==u&&s.indexOf(l)<0&&(m=be(c),g=be(u),d=m!==g?oi(n,l,c,g):parseFloat(c),h=parseFloat(u),t._pt=new Fe(t._pt,o,l,d,h-d,Yo),t._pt.u=g||0,t._props.push(l));eu(o,i)};Oe("padding,margin,Width,Radius",function(r,t){var e="Top",n="Right",i="Bottom",s="Left",a=(t<3?[e,n,i,s]:[e+s,e+n,i+n,i+s]).map(function(o){return t<2?r+o:"border"+o+r});js[t>1?"border"+r:r]=function(o,l,c,u,d){var h,m;if(arguments.length<4)return h=a.map(function(g){return Dn(o,g,c)}),m=h.join(" "),m.split(h[0]).length===5?h[0]:m;h=(u+"").split(" "),m={},a.forEach(function(g,_){return m[g]=h[_]=h[_]||h[(_-1)/2|0]}),o.init(l,m,d)}});var Wh={name:"css",register:Ko,targetTest:function(t){return t.style&&t.nodeType},init:function(t,e,n,i,s){var a=this._props,o=t.style,l=n.vars.startAt,c,u,d,h,m,g,_,f,p,y,v,T,w,A,b,C,M;wl||Ko(),this.styles=this.styles||Fh(t),C=this.styles.props,this.tween=n;for(_ in e)if(_!=="autoRound"&&(u=e[_],!(We[_]&&Ah(_,e,n,i,t,s)))){if(m=typeof u,g=js[_],m==="function"&&(u=u.call(n,i,t,s),m=typeof u),m==="string"&&~u.indexOf("random(")&&(u=kr(u)),g)g(this,t,_,u,n)&&(b=1);else if(_.substr(0,2)==="--")c=(getComputedStyle(t).getPropertyValue(_)+"").trim(),u+="",ni.lastIndex=0,ni.test(c)||(f=be(c),p=be(u),p?f!==p&&(c=oi(t,_,c,p)+p):f&&(u+=f)),this.add(o,"setProperty",c,u,i,s,0,0,_),a.push(_),C.push(_,0,o[_]);else if(m!=="undefined"){if(l&&_ in l?(c=typeof l[_]=="function"?l[_].call(n,i,t,s):l[_],xe(c)&&~c.indexOf("random(")&&(c=kr(c)),be(c+"")||c==="auto"||(c+=Ke.units[_]||be(Dn(t,_))||""),(c+"").charAt(1)==="="&&(c=Dn(t,_))):c=Dn(t,_),h=parseFloat(c),y=m==="string"&&u.charAt(1)==="="&&u.substr(0,2),y&&(u=u.substr(2)),d=parseFloat(u),_ in Mn&&(_==="autoAlpha"&&(h===1&&Dn(t,"visibility")==="hidden"&&d&&(h=0),C.push("visibility",0,o.visibility),Jn(this,o,"visibility",h?"inherit":"hidden",d?"inherit":"hidden",!d)),_!=="scale"&&_!=="transform"&&(_=Mn[_],~_.indexOf(",")&&(_=_.split(",")[0]))),v=_ in kn,v){if(this.styles.save(_),M=u,m==="string"&&u.substring(0,6)==="var(--"){if(u=Ye(t,u.substring(4,u.indexOf(")"))),u.substring(0,5)==="calc("){var x=t.style.perspective;t.style.perspective=u,u=Ye(t,"perspective"),x?t.style.perspective=x:ai(t,"perspective")}d=parseFloat(u)}if(T||(w=t._gsap,w.renderTransform&&!e.parseTransform||Wr(t,e.parseTransform),A=e.smoothOrigin!==!1&&w.smooth,T=this._pt=new Fe(this._pt,o,re,0,1,w.renderTransform,w,0,-1),T.dep=1),_==="scale")this._pt=new Fe(this._pt,w,"scaleY",w.scaleY,(y?lr(w.scaleY,y+d):d)-w.scaleY||0,Yo),this._pt.u=0,a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){C.push(Be,0,o[Be]),u=H0(u),w.svg?jo(t,u,0,A,0,this):(p=parseFloat(u.split(" ")[2])||0,p!==w.zOrigin&&Jn(this,w,"zOrigin",w.zOrigin,p),Jn(this,o,_,Zs(c),Zs(u)));continue}else if(_==="svgOrigin"){jo(t,u,1,A,0,this);continue}else if(_ in Hh){X0(this,w,_,h,y?lr(h,y+u):u);continue}else if(_==="smoothOrigin"){Jn(this,w,"smooth",w.smooth,u);continue}else if(_==="force3D"){w[_]=u;continue}else if(_==="transform"){q0(this,u,t);continue}}else _ in o||(_=Mr(_)||_);if(v||(d||d===0)&&(h||h===0)&&!A0.test(u)&&_ in o)f=(c+"").substr((h+"").length),d||(d=0),p=be(u)||(_ in Ke.units?Ke.units[_]:f),f!==p&&(h=oi(t,_,c,p)),this._pt=new Fe(this._pt,v?w:o,_,h,(y?lr(h,y+d):d)-h,!v&&(p==="px"||_==="zIndex")&&e.autoRound!==!1?P0:Yo),this._pt.u=p||0,v&&M!==u?(this._pt.b=c,this._pt.e=M,this._pt.r=R0):f!==p&&p!=="%"&&(this._pt.b=c,this._pt.r=C0);else if(_ in o)k0.call(this,t,_,c,y?y+u:u);else if(_ in t)this.add(t,_,c||t[_],y?y+u:u,i,s);else if(_!=="parseTransform"){gl(_,u);continue}v||(_ in o?C.push(_,0,o[_]):typeof t[_]=="function"?C.push(_,2,t[_]()):C.push(_,1,c||t[_])),a.push(_)}}b&&Dh(this)},render:function(t,e){if(e.tween._time||!Cl())for(var n=e._pt;n;)n.r(t,n.d),n=n._next;else e.styles.revert()},get:Dn,aliases:Mn,getSetter:function(t,e,n){var i=Mn[e];return i&&i.indexOf(",")<0&&(e=i),e in kn&&e!==Be&&(t._gsap.x||Dn(t,"x"))?n&&Yc===n?e==="scale"?U0:I0:(Yc=n||{})&&(e==="scale"?N0:O0):t.style&&!pl(t.style[e])?L0:~e.indexOf("-")?D0:bl(t,e)},core:{_removeProperty:ai,_getMatrix:Pl}};ze.utils.checkPrefix=Mr;ze.core.getStyleSaver=Fh;(function(r,t,e,n){var i=Oe(r+","+t+","+e,function(s){kn[s]=1});Oe(t,function(s){Ke.units[s]="deg",Hh[s]=1}),Mn[i[13]]=r+","+t,Oe(n,function(s){var a=s.split(":");Mn[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");Oe("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){Ke.units[r]="px"});ze.registerPlugin(Wh);var Xh=ze.registerPlugin(Wh)||ze;Xh.core.Tween;function Y0(r){const t=document.querySelectorAll(".intro-title .brush-text"),e=document.querySelector(".intro-subtitle"),n=document.querySelector(".intro-quote"),i=document.querySelector(".intro-desc");t.forEach(a=>{const o=a.getComputedTextLength();a.style.strokeDasharray=o,a.style.strokeDashoffset=o,a.style.fill="transparent"}),Xh.timeline({delay:.8}).to(t,{strokeDashoffset:0,fill:"#f5f0e6",duration:2.5,stagger:.4,ease:"power2.inOut"}).to(e,{opacity:1,y:0,duration:1,ease:"power2.out"},"-=1").to(n,{opacity:1,y:0,duration:1,ease:"power2.out"},"-=0.6").to(i,{opacity:1,y:0,duration:1,ease:"power2.out"},"-=0.6")}async function $0(){const r=await fetch("/data/content.json");if(!r.ok)throw new Error(`Failed to load content: ${r.status}`);return r.json()}function K0(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function nu(){return window.matchMedia("(pointer: coarse)").matches||window.innerWidth<768}const Zo="https://ncm-api-ochre.vercel.app",iu="12675557343";let Ce=[],Sn=-1,$t=null,ii=!1,bi=!1,Js=!1,Nn,ca,On,qh,Ll,Yh,$h,Kh,Jo,jh,Zh,Jh,Qh,Qo,Qs,ta;function j0(){Z0(),J0()}function Z0(){const r=document.createElement("div");r.className="music-widget",r.innerHTML=`
    ...
    <button class="music-btn" id="musicBtn" title="音乐播放器">
    ...
    </button>`,document.body.appendChild(r),Nn=document.getElementById("musicBtn"),ca=document.getElementById("musicPanel"),On=document.getElementById("musicList"),qh=document.getElementById("playerBar"),Ll=document.getElementById("playBtn"),Yh=document.getElementById("prevBtn"),$h=document.getElementById("nextBtn"),Kh=document.getElementById("progressFill"),Jo=document.getElementById("progressBar"),jh=document.getElementById("timeCurrent"),Zh=document.getElementById("timeTotal"),Jh=document.getElementById("playlistName"),Qh=document.getElementById("songCount"),Qo=document.getElementById("musicCover"),Qs=document.getElementById("trackInfo"),ta=document.getElementById("trackArtist")}function J0(){Q0(),Nn.addEventListener("click",r=>{if(Js){Js=!1;return}r.stopPropagation(),tx()}),document.addEventListener("click",r=>{!ca.contains(r.target)&&r.target!==Nn&&!Nn.contains(r.target)&&ex()}),Ll.addEventListener("click",r=>{r.stopPropagation(),ru()}),Yh.addEventListener("click",r=>{r.stopPropagation(),sx()}),$h.addEventListener("click",r=>{r.stopPropagation(),nd()}),Jo.addEventListener("click",r=>{if(!$t||!$t.duration)return;const t=Jo.getBoundingClientRect(),e=Math.max(0,Math.min(1,(r.clientX-t.left)/t.width));$t.currentTime=e*$t.duration}),document.addEventListener("keydown",r=>{r.target.tagName==="INPUT"||r.target.tagName==="TEXTAREA"||r.key===" "&&bi&&(r.preventDefault(),ru())})}function Q0(){const r=Nn.closest(".music-widget");if(!r)return;const t="wenruo_music_pos";let e=!1,n=0,i=0,s=0,a=0,o=!1;const l=4;function c(_){const f=_.touches&&_.touches[0]?_.touches[0]:_;return{x:f.clientX,y:f.clientY}}function u(_){e=!0,o=!1;const f=c(_);n=f.x,i=f.y;const p=r.getBoundingClientRect();s=p.left,a=p.top,r.classList.add("dragging"),r.style.transition="none",document.body.style.userSelect="none"}function d(_){if(!e)return;const f=c(_),p=f.x-n,y=f.y-i;(Math.abs(p)>l||Math.abs(y)>l)&&(o=!0,Js=!0);const v=r.getBoundingClientRect(),T=window.innerWidth,w=window.innerHeight;let A=s+p,b=a+y;A=Math.max(0,Math.min(A,T-v.width)),b=Math.max(0,Math.min(b,w-v.height)),r.style.right="auto",r.style.bottom="auto",r.style.left=A+"px",r.style.top=b+"px"}function h(){e&&(e=!1,r.classList.remove("dragging"),r.style.transition="",document.body.style.userSelect="",m(),o&&setTimeout(()=>{Js=!1},50))}function m(){try{const _=r.getBoundingClientRect();localStorage.setItem(t,JSON.stringify({left:_.left,top:_.top}))}catch{}}function g(){try{const _=localStorage.getItem(t);if(!_)return;const f=JSON.parse(_),p=window.innerWidth,y=window.innerHeight,v=r.getBoundingClientRect();let T=f.left,w=f.top;T=Math.max(0,Math.min(T,p-v.width)),w=Math.max(0,Math.min(w,y-v.height)),r.style.right="auto",r.style.bottom="auto",r.style.left=T+"px",r.style.top=w+"px"}catch{}}Nn.addEventListener("mousedown",u),Nn.addEventListener("touchstart",u,{passive:!0}),window.addEventListener("mousemove",d),window.addEventListener("touchmove",d,{passive:!0}),window.addEventListener("mouseup",h),window.addEventListener("touchend",h),window.addEventListener("resize",()=>{const _=r.getBoundingClientRect(),f=window.innerWidth,p=window.innerHeight;let y=_.left,v=_.top;y=Math.max(0,Math.min(y,f-_.width)),v=Math.max(0,Math.min(v,p-_.height)),r.style.left=y+"px",r.style.top=v+"px"}),g()}function tx(){bi=!bi,ca.classList.toggle("show",bi),Nn.classList.toggle("active",bi),bi&&Ce.length===0&&td()}function ex(){bi=!1,ca.classList.remove("show"),Nn.classList.remove("active")}async function td(){var r;On.innerHTML='<div class="music-loading"><div class="ink-spinner"></div><span>墨滴晕开中…</span></div>';try{const[t,e]=await Promise.all([fetch(`${Zo}/playlist/detail?id=${iu}`),fetch(`${Zo}/playlist/track/all?id=${iu}`)]);if(!t.ok)throw new Error(`HTTP ${t.status}`);if(!e.ok)throw new Error(`HTTP ${e.status}`);const n=await t.json(),i=await e.json();if(n.code!==200||!n.playlist){const a=n.message||n.msg||"API error";throw new Error(a)}const s=n.playlist;Jh.textContent=s.name||"未知歌单",Qh.textContent=`${s.trackCount||0} 首`,s.coverImgUrl&&(Qo.src=s.coverImgUrl+"?param=100y100",Qo.style.display=""),Ce=i.songs||i.data||s.tracks||[],ix(),ed()}catch(t){On.innerHTML=`<div class="music-error">✦ ${t.message}，点击重试</div>`,(r=On.querySelector(".music-error"))==null||r.addEventListener("click",td)}}async function nx(r){var n,i;const e=await(await fetch(`${Zo}/song/url/v1?id=${r}`)).json();if(e.code===200&&((i=(n=e.data)==null?void 0:n[0])!=null&&i.url))return e.data[0].url;throw new Error("URL not available")}function ix(){On.innerHTML=Ce.map((r,t)=>{const e=r.ar?r.ar.map(i=>i.name).join(" / "):"",n=tl((r.dt||0)/1e3);return`
      <div class="music-list-item${t===Sn?" active":""}" data-index="${t}">
        <span class="music-item-num">${t+1}</span>
        <div class="music-item-info">
          <div class="music-item-name">${au(r.name||"未知")}</div>
          <div class="music-item-artist">${au(e)}</div>
        </div>
        <span class="music-item-dur">${n}</span>
      </div>`}).join(""),On.querySelectorAll(".music-list-item").forEach(r=>{r.addEventListener("click",()=>{const t=parseInt(r.dataset.index);Ce[t]&&ua(t)})})}function Bs(){On.querySelectorAll(".music-list-item").forEach((t,e)=>{t.classList.toggle("active",e===Sn);const n=t.querySelector(".music-item-num");e===Sn&&ii?n.innerHTML='<span class="music-eq"><span></span><span></span><span></span></span>':n.textContent=e+1}),Ll.innerHTML=ii?'<svg viewBox="0 0 24 24" width="20" height="20"><path fill="currentColor" d="M6 19h4V5H6v14zm8-14v14h4V5h-4z"/></svg>':'<svg viewBox="0 0 24 24" width="20" height="20"><path fill="currentColor" d="M8 5v14l11-7z"/></svg>',ed()}function ed(){if(qh.style.display=Ce.length>0?"":"none",Sn>=0&&Ce[Sn]){const r=Ce[Sn];Qs.textContent=r.name||"—",ta.textContent=r.ar?r.ar.map(t=>t.name).join(" / "):""}else Qs.textContent="—",ta.textContent=""}function rx(r){Qs.textContent=r.name||"—",ta.textContent=r.ar?r.ar.map(t=>t.name).join(" / "):""}async function ua(r){if(r<0||r>=Ce.length)return;$t&&($t.pause(),$t.src=""),Sn=r,ii=!1,Bs();const t=Ce[r];rx(t);const e=On.querySelector(`[data-index="${r}"]`);e&&e.classList.add("loading");let n;try{n=await nx(t.id)}catch{e&&e.classList.remove("loading"),su();return}e&&e.classList.remove("loading"),$t=new Audio(n),$t.addEventListener("canplay",()=>{ii=!0,$t.play().catch(()=>{}),Bs()}),$t.addEventListener("ended",()=>nd()),$t.addEventListener("timeupdate",()=>{if($t&&$t.duration){const i=$t.currentTime/$t.duration*100;Kh.style.width=i+"%",jh.textContent=tl($t.currentTime)}}),$t.addEventListener("loadedmetadata",()=>{Zh.textContent=tl($t.duration)}),$t.addEventListener("error",()=>{ii=!1,Bs(),su()}),$t.load()}function ru(){if(!$t&&Ce.length>0){ua(0);return}$t&&(ii?($t.pause(),ii=!1):($t.play().catch(()=>{}),ii=!0),Bs())}function nd(){Ce.length!==0&&ua((Sn+1)%Ce.length)}function sx(){if(Ce.length!==0){if($t&&$t.currentTime>2){$t.currentTime=0;return}ua((Sn-1+Ce.length)%Ce.length)}}function su(){const r=On.querySelector(`[data-index="${Sn}"]`);r&&(r.classList.add("unavailable"),setTimeout(()=>r.classList.remove("unavailable"),2e3))}function tl(r){if(!r||isNaN(r))return"0:00";const t=Math.floor(r/60),e=Math.floor(r%60);return`${t}:${e<10?"0":""}${e}`}function au(r){const t=document.createElement("div");return t.textContent=r,t.innerHTML}let Nr=[];function ax(){const r=document.getElementById("notesGrid");r&&ox().then(()=>lx(r))}async function ox(){try{Nr=(await(await fetch("/data/content.json")).json()).notes||[]}catch{Nr=[]}}function lx(r){r.innerHTML=Nr.length===0?'<div class="note-empty">暂无笔记</div>':Nr.map(t=>{var e;return`
      ...
      </div>`}).join(""),r.querySelectorAll(".note-card").forEach(t=>{t.addEventListener("click",()=>{const e=Nr.find(n=>n.id===t.dataset.note);e&&cx(e)})})}function cx(r){const t=document.createElement("div");t.className="note-overlay",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const e=()=>t.remove();t.querySelector(".note-modal-close").addEventListener("click",e),t.addEventListener("click",n=>{n.target===t&&e()})}function ux(r){return ea(r).split(`
`).filter(t=>t.trim()).map(t=>`<p>${t}</p>`).join("")}function ea(r){const t=document.createElement("div");return t.textContent=r,t.innerHTML}function hx(){const r=document.createElement("div");r.className="note-overlay",r.innerHTML=`
...
`)],{type:"text/plain"}),p=document.createElement("a");p.href=URL.createObjectURL(f),p.download="gmail_aliases.txt",p.click(),URL.revokeObjectURL(p.href)})}const Xr="https://next-app-one-navy.vercel.app";function dx(){const r=document.getElementById("messageBoard");r&&el(r)}function fx(){return`<div class="msg-skeleton">
    <div class="msg-skeleton-item"></div>
    <div class="msg-skeleton-item"></div>
    <div class="msg-skeleton-item" style="width:80%"></div>
  </div>`}async function el(r){r.innerHTML=fx();try{const n=(await(await fetch(`${Xr}/api/messages`)).json()).messages||[];r.innerHTML=`
        ...
        ${n.map(i=>`
          <div class="msg-item">
            <div class="msg-meta">
              ...
              <span class="msg-time">${gx(i.time)}</span>
            </div>
            <div class="msg-content">${ou(i.message)}</div>
          </div>`).join("")}
      </div>`,r.querySelector("#msgForm").addEventListener("submit",async i=>{i.preventDefault();const s=r.querySelector("#msgName").value.trim(),a=r.querySelector("#msgText").value.trim();if(!s||!a)return;const o=r.querySelector(".msg-submit");o.disabled=!0,o.textContent="发送中…";try{const l=await fetch(`${Xr}/api/messages`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:s,message:a})});if(!l.ok)throw new Error(`HTTP ${l.status}`);el(r)}catch{o.textContent="发送失败，重试",o.disabled=!1}})}catch{r.innerHTML='<div class="msg-error">加载失败，点击重试</div>',r.querySelector(".msg-error").addEventListener("click",()=>el(r))}}function px(){const r=document.getElementById("contactForm");r&&r.addEventListener("submit",async t=>{t.preventDefault();const e=r.querySelector(".contact-submit"),n=e.textContent;e.disabled=!0,e.textContent="发送中…";try{await fetch(`${Xr}/api/contact`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:r.querySelector("#contactName").value,email:r.querySelector("#contactEmail").value,subject:r.querySelector("#contactSubject").value,message:r.querySelector("#contactMessage").value})}),e.textContent="已发送，感谢！",r.reset(),setTimeout(()=>{e.textContent=n,e.disabled=!1},3e3)}catch{e.textContent="发送失败，重试",e.disabled=!1}})}function mx(){fetch(`${Xr}/api/stats`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({type:"visit"})}).catch(()=>{})}async function _x(r){if(r)try{const e=await(await fetch(`${Xr}/api/stats`)).json();r.innerHTML=`
      ...
      <div class="stat-item"><span class="stat-num">${e.plays}</span><span class="stat-label">播放</span></div>`}catch{r.innerHTML='<div class="stat-item">统计加载失败</div>'}}function gx(r){const t=new Date(r),n=new Date-t;return n<6e4?"刚刚":n<36e5?`${Math.floor(n/6e4)} 分钟前`:n<864e5?`${Math.floor(n/36e5)} 小时前`:t.toLocaleDateString("zh-CN")}function ou(r){const t=document.createElement("div");return t.textContent=r,t.innerHTML}const Za={},id=(Za==null?void 0:Za.VITE_CHAT_API_BASE)||"https://hanbaoyu.ggff.net/v1",rd="cat-15e82e21a1292280105c3020f5dd0468884261de7144dedd",sd="wenruo_chat",lu=.7,nl=2048,cu="",uu=!0,vx="你是温若，一位清冷淡雅的剑修。请用简短、优美、古风的方式回答。";function xx(){const r=document.getElementById("page-chat");if(!r)return;const t=document.getElementById("chatModelBtn"),e=document.getElementById("chatModelText"),n=document.getElementById("chatModelMenu"),i=document.getElementById("chatModelOverlay"),s=document.getElementById("chatModelList"),a=document.getElementById("chatModelClose"),o=document.getElementById("chatSettings"),l=document.getElementById("chatSettingsPanel"),c=document.getElementById("chatSettingsOverlay"),u=document.getElementById("chatSettingsClose"),d=document.getElementById("chatMessages"),h=document.getElementById("chatInput"),m=document.getElementById("chatSend"),g=document.getElementById("chatTemp"),_=document.getElementById("chatTempVal"),f=document.getElementById("chatMaxTokens"),p=document.getElementById("chatOcMode"),y=document.getElementById("chatClear"),v=document.getElementById("chatClearHeader"),T=document.getElementById("chatExport"),w=document.getElementById("chatWelcomePanel"),A=document.getElementById("chatWelcomeOverlay"),b=document.getElementById("chatWelcomeClose");if(!t||!n||!s||!d||!h)return;const C=Cx();let M=[],x=null,P=null;hu(d,C.messages),rt(C.temperature),g.value=Math.round(C.temperature*10),f.value=C.maxTokens,p&&(p.checked=C.ocMode),Mx().then(pt=>{M=pt,Sx(s,e,M,C.model,W=>{C.model=W,xi(C),N()})}).catch(()=>{e.textContent="模型加载失败"});function k(){n&&i&&(n.classList.add("open"),i.classList.add("open"))}function N(){n&&i&&(n.classList.remove("open"),i.classList.remove("open"))}t.addEventListener("click",pt=>{pt.preventDefault(),pt.stopPropagation(),n.classList.contains("open")?N():(V(),k())}),i&&(i.addEventListener("click",N),i.addEventListener("touchstart",N,{passive:!0})),a&&a.addEventListener("click",N);function X(){l&&c&&(l.classList.add("open"),c.classList.add("open"))}function V(){l&&c&&(l.classList.remove("open"),c.classList.remove("open"))}o.addEventListener("click",pt=>{pt.preventDefault(),pt.stopPropagation(),l.classList.contains("open")?V():(N(),X())}),c&&(c.addEventListener("click",V),c.addEventListener("touchstart",V,{passive:!0})),u&&u.addEventListener("click",V),document.addEventListener("keydown",pt=>{pt.key==="Escape"&&(N(),V())}),new MutationObserver(()=>{r.classList.contains("active")||(N(),V())}).observe(r,{attributes:!0,attributeFilter:["class"]}),g.addEventListener("input",()=>{const pt=parseInt(g.value,10)/10;C.temperature=pt,rt(pt),xi(C)}),f.addEventListener("change",()=>{C.maxTokens=parseInt(f.value,10)||nl,xi(C)}),p&&p.addEventListener("change",()=>{C.ocMode=p.checked,xi(C)});function q(){confirm("确定要清空当前对话吗？")&&(C.messages=[],xi(C),hu(d,C.messages))}y&&y.addEventListener("click",()=>{q(),V()}),v&&v.addEventListener("click",pt=>{pt.preventDefault(),pt.stopPropagation(),q()}),T&&T.addEventListener("click",pt=>{pt.preventDefault(),pt.stopPropagation(),bx(C.messages)}),h.addEventListener("keydown",pt=>{pt.key==="Enter"&&(pt.preventDefault(),H())}),h.addEventListener("focus",()=>{setTimeout(()=>h.scrollIntoView({behavior:"smooth",block:"nearest"}),100)}),m.addEventListener("click",pt=>{pt.preventDefault(),pt.stopPropagation(),H()}),Rx(h);async function H(){var ht,ct,wt;const pt=h.value.trim();if(!pt)return;const W=C.model;if(!W){Ax(d,"请先选择模型");return}if(x)return;const j={role:"user",content:pt};C.messages.push(j),ad(d,j),h.value="",h.style.height="auto",xi(C),x=new AbortController,P="msg-"+Date.now(),wx(d,P);try{const yt=await fetch(`${id}/chat/completions`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${rd}`},body:JSON.stringify({model:W,messages:Tx(C.messages,C.ocMode),temperature:C.temperature,max_tokens:C.maxTokens,stream:!0}),signal:x.signal});if(!yt.ok){const Qt=await yt.text();throw new Error(`API ${yt.status}: ${Qt}`)}const Ut=yt.body.getReader(),Jt=new TextDecoder("utf-8");let L="";for(;;){const{done:Qt,value:zt}=await Ut.read();if(Qt)break;const gt=Jt.decode(zt,{stream:!0}).split(`
`);for(const se of gt){const St=se.trim();if(!(!St||St==="data: [DONE]")&&St.startsWith("data:"))try{const R=((wt=(ct=(ht=JSON.parse(St.slice(5)).choices)==null?void 0:ht[0])==null?void 0:ct.delta)==null?void 0:wt.content)||"";R&&(L+=R,du(P,L))}catch{}}}C.messages.push({role:"assistant",content:L}),xi(C),Qa(P,L)}catch(yt){yt.name==="AbortError"?Qa(P,"已取消"):(du(P,`请求失败：${yt.message}`),Qa(P,`请求失败：${yt.message}`))}finally{x=null,P=null}}function rt(pt){_.textContent=pt.toFixed(1)}function ot(){localStorage.getItem("wenruo_chat_welcome")!=="1"&&w&&A&&(w.classList.add("open"),A.classList.add("open"))}function lt(){w&&A&&(w.classList.remove("open"),A.classList.remove("open"));try{localStorage.setItem("wenruo_chat_welcome","1")}catch{}}b&&b.addEventListener("click",lt),A&&A.addEventListener("click",lt),new MutationObserver(()=>{r.classList.contains("active")?ot():lt()}).observe(r,{attributes:!0,attributeFilter:["class"]}),r.classList.contains("active")&&ot()}async function Mx(){const r=await fetch(`${id}/models`,{headers:{Authorization:`Bearer ${rd}`}});if(!r.ok)throw new Error(`HTTP ${r.status}`);const e=((await r.json()).data||[]).map(n=>({id:n.id,name:n.id}));return e.sort((n,i)=>n.name.localeCompare(i.name)),e}function Sx(r,t,e,n,i){if(!r)return;if(r.innerHTML="",e.length===0){t.textContent="无可用模型";return}const s=n||e[0].id,a=e.find(o=>o.id===s)||e[0];t.textContent=Ja(a.name),e.forEach(o=>{const l=yx(o.id),c=l?Ex(l):"",u=document.createElement("button");u.className="chat-model-item",u.type="button",o.id===s&&u.classList.add("active"),u.innerHTML=`
      <div class="chat-model-item-main">
        ${c}
        <span class="chat-model-name">${il(Ja(o.name))}</span>
      </div>
      <span class="chat-model-id">${il(o.id)}</span>`,u.addEventListener("click",()=>{r.querySelectorAll(".chat-model-item").forEach(d=>d.classList.remove("active")),u.classList.add("active"),t.textContent=Ja(o.name),i(o.id)}),r.appendChild(u)})}function yx(r){const t=r.toLowerCase();return t.includes("deepseek")?"deepseek":t.includes("claude")||t.includes("anthropic")?"anthropic":t.includes("gpt")||t.includes("openai")||t.includes("o1-")||t.includes("o3-")?"chatgpt":t.includes("gemini")||t.includes("google")?"gemini":null}function Ex(r){return{deepseek:'<svg class="chat-model-icon" viewBox="0 0 24 24" aria-hidden="true"><path fill="#4D6BFA" d="M21.2 11c-.5-1.8-2.2-3.2-4.2-3.4-.4 0-.8-.3-1-.7-.2-.4-.1-.9.3-1.2.3-.3.9-.4 1.3-.2.3.2.6.5.7.8 0 .1.1.1.2.1.1 0 .2-.1.2-.2 0-.1-.1-.2-.2-.3-.5-.4-1.2-.4-1.8-.2-.8.3-1.4 1-1.5 1.8-.1.5 0 1.1.4 1.5.3.3.8.5 1.2.6.5.2 1.1.3 1.7.5.7.3 1.3.8 1.6 1.5.3.7.2 1.5-.2 2.1-.4.7-1.1 1.2-1.9 1.3-.7.1-1.5 0-2.1-.4-.6-.4-1.1-1-1.2-1.7-.1-.5 0-1 .3-1.3.3-.4.8-.5 1.2-.5.2 0 .5 0 .7.1.1 0 .2 0 .2-.1 0-.1 0-.2-.1-.2-.1-.1-.3-.2-.4-.2-.7-.2-1.5 0-2 .6-.5.6-.7 1.4-.5 2.1.2.9.8 1.7 1.6 2.1.8.4 1.8.5 2.7.2.9-.3 1.7-1.1 2-2 .3-.8.1-1.7-.4-2.4zM12 2.5c-4.4 0-8 3.4-8 7.8 0 4 2.9 7.3 6.8 8 .5.1 1.1 0 1.6-.3.4-.3.8-.7.9-1.2.1-.5 0-1-.4-1.3-.3-.3-.9-.5-1.3-.3-.4.1-.8.5-.9.8-.1.4-.1.8.2 1 .2.2.5.3.7.3.1 0 .3.2.2.4 0 .1-.1.3-.3.3-.3.2-.7.2-1.1.1-3-1-5.2-3.7-5.2-7 0-3.6 2.9-6.5 6.5-6.5 3.1 0 5.7 2.1 6.4 5 .1.4.5.7.9.8.4.1.9 0 1.2-.3.3-.3.4-.8.2-1.2C19.2 4.8 15.9 2.5 12 2.5z"/></svg>',anthropic:'<svg class="chat-model-icon" viewBox="0 0 24 24" aria-hidden="true"><path fill="#D97757" d="M12 2L4 20h2.5l2-5h7l2 5H20L12 2zm1.5 11h-3l1.5-3.8 1.5 3.8z"/></svg>',chatgpt:'<svg class="chat-model-icon" viewBox="0 0 24 24" aria-hidden="true"><path fill="#10A37F" d="M12 2L4 6v12l8 4 8-4V6l-8-4zm0 2.2L17.5 7 12 9.8 6.5 7 12 4.2zM6 8.5l5 2.8v5.4l-5-2.5V8.5zm7 8.2v-5.4l5-2.8v5.7l-5 2.5z"/></svg>',gemini:'<svg class="chat-model-icon" viewBox="0 0 24 24" aria-hidden="true"><path fill="#4285F4" d="M12 1l2.5 7.5L12 12l-2.5-3.5L12 1z"/><path fill="#EA4335" d="M23 12l-7.5 2.5L12 12l3.5-2.5L23 12z"/><path fill="#FBBC05" d="M12 23l-2.5-7.5L12 12l2.5 3.5L12 23z"/><path fill="#34A853" d="M1 12l7.5-2.5L12 12l-3.5 2.5L1 12z"/></svg>'}[r]||""}function Ja(r){if(!r)return"";const t=18;return r.length>t?r.slice(0,t)+"…":r}function Tx(r,t){const n=r.slice(-20).map(i=>({role:i.role,content:i.content}));return t?[{role:"system",content:vx},...n]:n}function bx(r){if(!r||r.length===0){alert("当前没有对话记录可导出");return}const t=r.map(s=>`${s.role==="user"?"你":"温若"}：${s.content}`).join(`
...
`),e=new Blob([t],{type:"text/plain;charset=utf-8"}),n=URL.createObjectURL(e),i=document.createElement("a");i.href=n,i.download=`灵犀对话-${new Date().toISOString().slice(0,10)}.txt`,document.body.appendChild(i),i.click(),document.body.removeChild(i),URL.revokeObjectURL(n)}function hu(r,t){if(r.innerHTML="",t.length===0){r.innerHTML=`
      ...
      </div>`;return}t.forEach(e=>ad(r,e)),ts(r)}function ad(r,t){const e=r.querySelector(".chat-empty");e&&e.remove();const n=document.createElement("div");n.className=`chat-message chat-message-${t.role}`,n.innerHTML=`
    <div class="chat-avatar">${t.role==="user"?"客":"若"}</div>
    <div class="chat-bubble"><div class="chat-text">${il(t.content)}</div></div>`,r.appendChild(n),ts(r)}function Ax(r,t){const e=document.createElement("div");e.className="chat-system",e.textContent=t,r.appendChild(e),ts(r)}function wx(r,t){const e=r.querySelector(".chat-empty");e&&e.remove();const n=document.createElement("div");n.className="chat-message chat-message-assistant streaming",n.id=t,n.innerHTML=`
    <div class="chat-avatar">若</div>
    <div class="chat-bubble"><div class="chat-text"></div><span class="chat-cursor"></span></div>`,r.appendChild(n),ts(r)}function du(r,t){const e=document.getElementById(r);if(!e)return;const n=e.querySelector(".chat-text");n&&(n.textContent=t);const i=document.getElementById("chatMessages");ts(i)}function Qa(r,t){const e=document.getElementById(r);if(!e)return;e.classList.remove("streaming");const n=e.querySelector(".chat-cursor");n&&n.remove();const i=e.querySelector(".chat-text");i&&(i.textContent=t)}function ts(r){r&&(r.scrollTop=r.scrollHeight)}function Cx(){try{const r=localStorage.getItem(sd),t=r?JSON.parse(r):{};return{messages:Array.isArray(t.messages)?t.messages:[],model:t.model||cu,temperature:typeof t.temperature=="number"?t.temperature:lu,maxTokens:t.maxTokens||nl,ocMode:typeof t.ocMode=="boolean"?t.ocMode:uu}}catch{return{messages:[],model:cu,temperature:lu,maxTokens:nl,ocMode:uu}}}function xi(r){try{localStorage.setItem(sd,JSON.stringify(r))}catch{}}function il(r){const t=document.createElement("div");return t.textContent=r,t.innerHTML}function Rx(r){!r||r.tagName!=="TEXTAREA"||r.addEventListener("input",()=>{r.style.height="auto",r.style.height=Math.min(r.scrollHeight,160)+"px"})}async function Px(){const r=document.getElementById("pathTimeline");if(r)try{const n=((await(await fetch("/data/content.json?v="+Date.now())).json()).chronicle||[]).slice().reverse();r.innerHTML=n.length===0?'<div class="path-item">暂无记录</div>':n.map(i=>`
        <div class="path-item">
          <div class="path-year">${to(i.year||"")}</div>
          <div class="path-title">${to(i.title||"")}</div>
          <div class="path-desc">${to(i.desc||"")}</div>
        </div>
      `).join("")}catch{r.innerHTML='<div class="path-item">剑谱加载失败</div>'}}function to(r){const t=document.createElement("div");return t.textContent=r,t.innerHTML}const fu=[{name:"上签 · 破云",text:"剑出鞘时云自开，今日所困，明日皆成踏脚石。"},{name:"上签 · 听松",text:"松下听风，不争而胜。慢下来，答案自己会走过来。"},{name:"中签 · 渡溪",text:"溪水虽浅，湿鞋难免。小心细节，便可稳渡。"},{name:"中签 · 磨刀",text:"工欲善其事，先磨三日刀。眼下蛰伏，是在攒锋。"},{name:"上签 · 拾叶",text:"落叶非无情物，化作春泥更护花。放下即是得到。"},{name:"下签 · 雾岭",text:"岭上雾重，宜守不宜进。今日多思少动，养精蓄锐。"},{name:"上签 · 惊鸿",text:"惊鸿一瞥，机遇转瞬即逝。看到就出手，别犹豫。"},{name:"中签 · 归舟",text:"行到水穷处，坐看云起时。此路不通时，换个码头。"},{name:"上签 · 藏锋",text:"大巧若拙，大辩若讷。真正的高手，从不亮剑两次。"},{name:"下签 · 逆水",text:"逆水行舟，不进则退。今日宜复盘旧账，清理负累。"}];function Lx(){const r=document.getElementById("fortuneBox");if(!r)return;const t=document.getElementById("fortuneBtn"),e=document.getElementById("fortuneResult");let n=!1;t.addEventListener("click",()=>{n||(n=!0,t.disabled=!0,e.classList.remove("show"),r.classList.add("shaking"),setTimeout(()=>{r.classList.remove("shaking");const i=fu[Math.floor(Math.random()*fu.length)];e.innerHTML='<span class="fortune-name">'+i.name+"</span>"+i.text,e.classList.add("show"),t.disabled=!1,n=!1},1600))})}function Dx(){if("IntersectionObserver"in window){const r=new IntersectionObserver(t=>{t.forEach(e=>{e.isIntersecting&&e.target.classList.add("is-visible")})},{threshold:.15,rootMargin:"0px 0px -40px 0px"});document.querySelectorAll(".section-card, .note-card, .path-item, .explore-header").forEach(t=>{t.classList.add("reveal"),r.observe(t)})}}function Ix(){window.matchMedia("(pointer: coarse)").matches||document.querySelectorAll(".tilt-card, .section-card, .note-card, .path-item").forEach(r=>{r.addEventListener("mousemove",t=>{const e=r.getBoundingClientRect(),n=t.clientX-e.left,i=t.clientY-e.top,s=n/e.width-.5,a=i/e.height-.5;r.style.transform=`perspective(1000px) rotateY(${s*6}deg) rotateX(${-a*6}deg) translateZ(6px)`}),r.addEventListener("mouseleave",()=>{r.style.transform=""})})}function Ux(){const r=document.createElement("div");r.className="scroll-ink",r.setAttribute("aria-hidden","true"),document.body.appendChild(r),window.addEventListener("scroll",()=>{const t=document.documentElement,e=t.scrollTop||document.body.scrollTop,n=t.scrollHeight-t.clientHeight;r.style.width=(n?e/n*100:0)+"%"},{passive:!0})}function Nx(){const r=document.getElementById("inkLoader");r&&(document.readyState==="complete"?setTimeout(()=>r.classList.add("loaded"),600):window.addEventListener("load",()=>{setTimeout(()=>r.classList.add("loaded"),300)}))}async function Ox(){wv(document.getElementById("bg-image"));const r=await $0(),t=document.querySelector(".intro-quote");t&&r.quotes&&r.quotes.length?(t.textContent=r.quotes[0].text,Fx(t,r.quotes)):t&&(t.textContent=r.intro.quote,Bx(t,r.intro.quote)),document.querySelector(".intro-subtitle").textContent=r.intro.subtitle,document.querySelector(".intro-desc").textContent=r.intro.desc,document.title=r.site.title;const e=document.getElementById("webgl-bg"),n=document.getElementById("cursor-aura");let i=null,s=null,a=null,o=null;if(!K0())try{i=new yv(e),s=new Ev(i.scene,{count:nu()?3:6}),nu()||(a=new Tv(n));const l=new $u,c=()=>{const u=l.getElapsedTime(),d=window.scrollY/(document.body.scrollHeight-window.innerHeight);i.animate(),s&&s.update(u,d),o=requestAnimationFrame(c)};c()}catch(l){console.warn("WebGL effects unavailable, falling back to static content:",l),e.style.background="radial-gradient(ellipse at center, #1a1f18 0%, #0c0f0a 100%)"}return Y0(r.intro),j0(),zx(),ax(),kx(),dx(),px(),xx(),Px(),Lx(),Hx(),Dx(),Ix(),Ux(),Nx(),mx(),_x(document.getElementById("statsBar")),()=>{o&&cancelAnimationFrame(o),i&&i.destroy(),a&&a.destroy()}}function Fx(r,t){let e=0;setInterval(()=>{e=(e+1)%t.length,r.style.opacity="0",setTimeout(()=>{r.textContent=t[e].text||t[e],r.style.opacity="1"},500)},6e3)}async function Bx(r,t){try{const e=await fetch("https://v1.hitokoto.cn");if(!e.ok)throw new Error("Hitokoto API error");const n=await e.json();n&&n.hitokoto&&(r.textContent=n.hitokoto)}catch(e){console.warn("Hitokoto load failed:",e),r.textContent=t}}function zx(){const r=document.querySelectorAll(".ios-nav-tab"),t=document.querySelectorAll(".page"),e=document.querySelector(".ios-nav-inner");if(r.forEach(n=>{n.addEventListener("click",()=>{const i=n.dataset.page;r.forEach(s=>s.classList.remove("active")),n.classList.add("active"),t.forEach(s=>{s.classList.toggle("active",s.id===`page-${i}`)}),window.scrollTo({top:0,behavior:"smooth"})})}),e){const n=()=>{e.classList.toggle("scrolled",window.scrollY>10)};window.addEventListener("scroll",n,{passive:!0}),n()}}function kx(){const r=document.querySelector('[data-tool="gmail-alias"]');r&&r.addEventListener("click",()=>hx())}function Hx(){document.querySelectorAll(".note-card").forEach(r=>{r.addEventListener("mousemove",t=>{const e=r.getBoundingClientRect();r.style.setProperty("--mx",(t.clientX-e.left)/e.width*100+"%"),r.style.setProperty("--my",(t.clientY-e.top)/e.height*100+"%")})})}Ox().catch(r=>{console.error("Failed to initialize app:",r)});
//# sourceMappingURL=index-DX3o2KH3.js.map
